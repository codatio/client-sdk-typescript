...
| `unitAmount`                                                          | *Decimal | number*                                                    | :heavy_minus_sign:                                                    | Unit price of the goods or service.                                   |
| `quantity`                                                            | *Decimal | number*                                                    | :heavy_minus_sign:                                                    | Number of units of goods or services received.                        |
| `taxAmount`                                                           | *Decimal | number*                                                    | :heavy_minus_sign:                                                    | Amount of tax applied to the line item.                               |
