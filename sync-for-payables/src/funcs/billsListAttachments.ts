 ...
 */
export async function billsListAttachments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBillAttachmentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(shared.Attachment$inboundSchema)),
    M.jsonErr(
