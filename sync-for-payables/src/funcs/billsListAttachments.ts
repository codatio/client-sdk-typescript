...
type Call = CodatSyncPayables["bills"]["listAttachments"];

export function billsListAttachments(
    ...
    return new APIPromise(toResult(() => client.bills.listAttachments(request, options)));
}
