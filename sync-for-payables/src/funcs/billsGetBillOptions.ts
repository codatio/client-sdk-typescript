...
type Call = CodatSyncPayables["bills"]["getBillOptions"];

export function billsGetBillOptions(
    ...
    return new APIPromise(toResult(() => client.bills.getBillOptions(request, options)));
}
