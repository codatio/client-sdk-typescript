 ...
 */
export async function billPaymentsGetPaymentOptions(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetMappingOptionsPaymentsRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.PaymentMappingOptions$inboundSchema),
    m$.jsonErr(
