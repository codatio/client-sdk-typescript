...
type Call = CodatSyncPayables["bills"]["uploadAttachment"];

export function billsUploadAttachment(
    ...
    return new APIPromise(toResult(() => client.bills.uploadAttachment(request, options)));
}
