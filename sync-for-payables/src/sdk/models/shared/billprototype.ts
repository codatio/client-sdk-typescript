...
/** @internal */
export const BillPrototype$inboundSchema: z.ZodType<
  BillPrototype,
  z.ZodTypeDef,
  unknown
> = z.object({
 ...
 */
export namespace BillPrototype$ {
  /** @deprecated use `BillPrototype$inboundSchema` instead. */
  export const inboundSchema = BillPrototype$inboundSchema;
  /** @deprecated use `BillPrototype$outboundSchema` instead. */
