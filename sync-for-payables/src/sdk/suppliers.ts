...
export class Suppliers {
    ...
    async getCreateUpdateModel(
        ...
        retries?: utils.RetryConfig,
        config?: AxiosRequestConfig
    ): Promise<operations.GetCreateUpdateSupplierModelResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCreateUpdateSupplierModelRequest(req);
        }
        ...
        const res: operations.GetCreateUpdateSupplierModelResponse =
            new operations.GetCreateUpdateSupplierModelResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    async list(
        ...
        res.next = async (): Promise<operations.ListSuppliersResponse | null> => {
