...
export class Payments {
    ...
    async list(
        ...
        res.next = async (): Promise<operations.ListPaymentsResponse | null> => {
    ...
    async listMethods(
        ...
        res.next = async (): Promise<operations.ListPaymentMethodsResponse | null> => {
            const nextCursor = jp.value(JSON.parse(decodedRes), "");
            if (nextCursor === undefined) {
                return null;
            }

            return await this.listMethods(
                {
                    ...req,
                },
                retries,
