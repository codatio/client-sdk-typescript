...
export class AccountingBankAccounts {
     ...
     *
     */
    async getAccountingBankAccount(
     ...
     *
     */
    async listAccountingBankAccounts(
        ...
        res.next = async (): Promise<operations.ListAccountingBankAccountsResponse | null> => {
            const nextCursor = jp.value(JSON.parse(decodedRes), "");
            if (nextCursor === undefined) {
                return null;
            }

            return await this.listAccountingBankAccounts(
                {
                    ...req,
                },
                retries,
