...
export type BillCreditNote = {
   ...
   */
  createdFromRefs?: Array<RecordReference> | null | undefined;
  /**
...
> = z.object({
  ...
  createdFromRefs: z.nullable(
    z.array(z.lazy(() => RecordReference$inboundSchema)),
  ).optional(),
...
/** @internal */
export type BillCreditNote$Outbound = {
  modifiedDate?: string | undefined;
  sourceModifiedDate?: string | undefined;
  id?: string | undefined;
  billCreditNoteNumber?: string | null | undefined;
  ...
  paymentAllocations?:
    ...
    | null
    | undefined;
  createdFromRefs?: Array<RecordReference$Outbound> | null | undefined;
  note?: string | null | undefined;
...
/** @internal */
export const BillCreditNote$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  paymentAllocations: z.nullable(z.array(PaymentAllocationItems$outboundSchema))
    .optional(),
  createdFromRefs: z.nullable(
    z.array(z.lazy(() => RecordReference$outboundSchema)),
  ).optional(),
  note: z.nullable(z.string()).optional(),
...
export namespace BillCreditNote$ {
  /** @deprecated use `BillCreditNote$inboundSchema` instead. */
  export const inboundSchema = BillCreditNote$inboundSchema;
  /** @deprecated use `BillCreditNote$outboundSchema` instead. */
  export const outboundSchema = BillCreditNote$outboundSchema;
  /** @deprecated use `BillCreditNote$Outbound` instead. */
  export type Outbound = BillCreditNote$Outbound;
}
