...
export function updateBillCreditNoteResponseRecordReferenceFromJSON(
  jsonString: string,
): SafeParseResult<
  UpdateBillCreditNoteResponseRecordReference,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UpdateBillCreditNoteResponseRecordReference$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UpdateBillCreditNoteResponseRecordReference' from JSON`,
  );
}
...
export function updateBillCreditNoteResponseAccountingBillCreditNoteFromJSON(
  jsonString: string,
): SafeParseResult<
  UpdateBillCreditNoteResponseAccountingBillCreditNote,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UpdateBillCreditNoteResponseAccountingBillCreditNote$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UpdateBillCreditNoteResponseAccountingBillCreditNote' from JSON`,
  );
}
