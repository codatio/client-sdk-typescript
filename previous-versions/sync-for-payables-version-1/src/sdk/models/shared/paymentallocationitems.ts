...
export namespace PaymentAllocationItems$ {
  /** @deprecated use `PaymentAllocationItems$inboundSchema` instead. */
  export const inboundSchema = PaymentAllocationItems$inboundSchema;
  /** @deprecated use `PaymentAllocationItems$outboundSchema` instead. */
  export const outboundSchema = PaymentAllocationItems$outboundSchema;
  /** @deprecated use `PaymentAllocationItems$Outbound` instead. */
  export type Outbound = PaymentAllocationItems$Outbound;
}
