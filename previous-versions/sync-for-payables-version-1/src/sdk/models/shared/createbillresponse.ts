...
export function createBillResponsePurchaseOrderReferenceFromJSON(
  jsonString: string,
): SafeParseResult<
  CreateBillResponsePurchaseOrderReference,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CreateBillResponsePurchaseOrderReference$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CreateBillResponsePurchaseOrderReference' from JSON`,
  );
}
...
export function createBillResponseWithholdingTaxFromJSON(
  jsonString: string,
): SafeParseResult<CreateBillResponseWithholdingTax, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateBillResponseWithholdingTax$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateBillResponseWithholdingTax' from JSON`,
  );
}
...
export function createBillResponseAllocationFromJSON(
  jsonString: string,
): SafeParseResult<CreateBillResponseAllocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateBillResponseAllocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateBillResponseAllocation' from JSON`,
  );
}
...
export function createBillResponseAccountingPaymentAllocationFromJSON(
  jsonString: string,
): SafeParseResult<
  CreateBillResponseAccountingPaymentAllocation,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CreateBillResponseAccountingPaymentAllocation$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CreateBillResponseAccountingPaymentAllocation' from JSON`,
  );
}
