...
export function validDatatypeLinkItemsFromJSON(
  jsonString: string,
): SafeParseResult<ValidDatatypeLinkItems, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ValidDatatypeLinkItems$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ValidDatatypeLinkItems' from JSON`,
  );
}
