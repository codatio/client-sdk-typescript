 ...
 */
export async function billCreditNotesList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListBillCreditNotesRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.BillCreditNotes$inboundSchema),
    m$.jsonErr(
