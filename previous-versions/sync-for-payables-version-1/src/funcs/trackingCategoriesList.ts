 ...
 */
export async function trackingCategoriesList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListTrackingCategoriesRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/companies/{companyId}/data/trackingCategories")(
    pathParams$,
  );
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.TrackingCategories$inboundSchema),
    m$.jsonErr(
