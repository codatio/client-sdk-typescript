...
type Call = CodatBankFeeds["sourceAccounts"]["create"];

export function sourceAccountsCreate(
    ...
    return new APIPromise(toResult(() => client.sourceAccounts.create(request, options)));
}
