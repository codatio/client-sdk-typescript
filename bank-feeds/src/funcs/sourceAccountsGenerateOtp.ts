...
type Call = CodatBankFeeds["sourceAccounts"]["generateOtp"];

export function sourceAccountsGenerateOtp(
    ...
    return new APIPromise(toResult(() => client.sourceAccounts.generateOtp(request, options)));
}
