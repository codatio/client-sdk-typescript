...
type Call = CodatBankFeeds["transactions"]["getCreateModel"];

export function transactionsGetCreateModel(
    ...
    return new APIPromise(toResult(() => client.transactions.getCreateModel(request, options)));
}
