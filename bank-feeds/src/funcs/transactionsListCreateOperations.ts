...
type Call = CodatBankFeeds["transactions"]["listCreateOperations"];

export function transactionsListCreateOperations(
    ...
    return new APIPromise(toResult(() => client.transactions.listCreateOperations(request, options)));
}
