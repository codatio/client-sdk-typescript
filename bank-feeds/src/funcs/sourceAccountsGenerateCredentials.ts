 ...
 */
export async function sourceAccountsGenerateCredentials(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GenerateCredentialsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.BankAccountCredentials$inboundSchema),
    M.jsonErr(
