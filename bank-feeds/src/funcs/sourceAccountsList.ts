...
type Call = CodatBankFeeds["sourceAccounts"]["list"];

export function sourceAccountsList(
    ...
    return new APIPromise(toResult(() => client.sourceAccounts.list(request, options)));
}
