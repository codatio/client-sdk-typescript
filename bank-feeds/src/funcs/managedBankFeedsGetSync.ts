...
type Call = CodatBankFeeds["managedBankFeeds"]["getSync"];

export function managedBankFeedsGetSync(
    ...
    return new APIPromise(toResult(() => client.managedBankFeeds.getSync(request, options)));
}
