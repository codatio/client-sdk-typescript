 ...
 */
export async function sourceAccountsCreateBatch(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateBatchSourceAccountRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateBatchSourceAccountResponse$inboundSchema),
    M.json(207, operations.CreateBatchSourceAccountResponse$inboundSchema),
    M.jsonErr(
