...
export function managedBankFeedsGetLatestSync(
  ...
  Result<
    shared.SyncStatusResult | undefined,
    | errors.ErrorMessage
    | CodatBankFeedsError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetLatestManagedBankFeedSyncRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    sourceAccountId: encodeSimple("sourceAccountId", payload.sourceAccountId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.SyncStatusResult$inboundSchema.optional()),
    M.nil(204, shared.SyncStatusResult$inboundSchema.optional()),
