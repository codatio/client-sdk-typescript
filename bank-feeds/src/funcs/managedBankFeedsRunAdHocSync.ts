...
type Call = CodatBankFeeds["managedBankFeeds"]["runAdHocSync"];

export function managedBankFeedsRunAdHocSync(
    ...
    return new APIPromise(toResult(() => client.managedBankFeeds.runAdHocSync(request, options)));
}
