...
type Call = CodatBankFeeds["transactions"]["getCreateOperation"];

export function transactionsGetCreateOperation(
    ...
    return new APIPromise(toResult(() => client.transactions.getCreateOperation(request, options)));
}
