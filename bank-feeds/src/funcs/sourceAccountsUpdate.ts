...
type Call = CodatBankFeeds["sourceAccounts"]["update"];

export function sourceAccountsUpdate(
    ...
    return new APIPromise(toResult(() => client.sourceAccounts.update(request, options)));
}
