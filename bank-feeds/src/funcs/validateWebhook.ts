...
import type { CodatBankFeedsCore } from "../core";
...
type ValidateWebhookResult = shared.ClientRateLimitWebhook | shared.SourceAccountWebhook | undefined;
...
const WEBHOOK_MATCH_ORDER: { name: string; spec: WebhookMatchSpec }[] = [
    ...
    { name: "SourceAccountWebhook", spec: {"kind": "object", "required": [], "props": {"id": "string", "eventType": "string", "generatedDate": "string", "payload": {"kind": "object", "required": [], "props": {"referenceCompany": {"kind": "object", "required": [], "props": {"id": "string", "name": "string", "description": "string", "links": {"kind": "object", "required": [], "props": {"portal": "string"}}, "tags": {"kind": "object", "required": [], "props": {}}}}, "companyId": "string", "connectionId": "string", "sourceAccount": "any"}}}} }
];

export function validateWebhook(_client: CodatBankFeedsCore, { request }: { request: { body: string; method: string; url: string; headers: Record<string, string> | Headers } | Request }): APIPromise<Result<ValidateWebhookResult, SDKValidationError>> {
    void _client;
