...
type Call = CodatBankFeeds["sourceAccounts"]["deleteCredentials"];

export function sourceAccountsDeleteCredentials(
    ...
    return new APIPromise(toResult(() => client.sourceAccounts.deleteCredentials(request, options)));
}
