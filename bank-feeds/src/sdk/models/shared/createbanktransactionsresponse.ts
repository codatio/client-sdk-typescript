...
import {
  ...
  CreateBankTransactions$inboundSchema,
  CreateBankTransactions$Outbound,
  CreateBankTransactions$outboundSchema,
} from "./createbanktransactions.js";
import {
  DataType,
...
export type CreateBankTransactionsResponse = {
  data?: CreateBankTransactions | undefined;
  /**
...
/** @internal */
export const CreateBankTransactionsResponse$inboundSchema: z.ZodType<
  CreateBankTransactionsResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  data: CreateBankTransactions$inboundSchema.optional(),
...
/** @internal */
export type CreateBankTransactionsResponse$Outbound = {
  data?: CreateBankTransactions$Outbound | undefined;
...
/** @internal */
export const CreateBankTransactionsResponse$outboundSchema: z.ZodType<
  CreateBankTransactionsResponse$Outbound,
  z.ZodTypeDef,
  CreateBankTransactionsResponse
> = z.object({
  data: CreateBankTransactions$outboundSchema.optional(),
...
export namespace CreateBankTransactionsResponse$ {
  /** @deprecated use `CreateBankTransactionsResponse$inboundSchema` instead. */
  export const inboundSchema = CreateBankTransactionsResponse$inboundSchema;
  /** @deprecated use `CreateBankTransactionsResponse$outboundSchema` instead. */
  export const outboundSchema = CreateBankTransactionsResponse$outboundSchema;
  /** @deprecated use `CreateBankTransactionsResponse$Outbound` instead. */
  export type Outbound = CreateBankTransactionsResponse$Outbound;
}

export function createBankTransactionsResponseToJSON(
  createBankTransactionsResponse: CreateBankTransactionsResponse,
): string {
  return JSON.stringify(
    CreateBankTransactionsResponse$outboundSchema.parse(
      createBankTransactionsResponse,
    ),
  );
}

export function createBankTransactionsResponseFromJSON(
  jsonString: string,
): SafeParseResult<CreateBankTransactionsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateBankTransactionsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateBankTransactionsResponse' from JSON`,
  );
}
