...
/** @internal */
export const HalRef$inboundSchema: z.ZodType<HalRef, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const HalRef$outboundSchema: z.ZodType<HalRef$Outbound, z.ZodTypeDef, HalRef> = z.object({
    href: z.string().optional(),
});
