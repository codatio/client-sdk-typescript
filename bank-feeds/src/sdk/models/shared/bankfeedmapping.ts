...
/** @internal */
export const BankFeedMapping$inboundSchema: z.ZodType<BankFeedMapping, z.ZodTypeDef, unknown> =
    z.object({
        ...
        targetAccountOptions: z.nullable(z.array(TargetAccountOption$inboundSchema)).optional(),
...
> = z.object({
    ...
    targetAccountName: z.string().optional(),
    status: z.string().optional(),
    targetAccountOptions: z.nullable(z.array(TargetAccountOption$outboundSchema)).optional(),
    feedStartDate: z.string().optional(),
});
