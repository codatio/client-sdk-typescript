...
/** @internal */
export const BankAccountType$inboundSchema: z.ZodNativeEnum<typeof BankAccountType> =
    z.nativeEnum(BankAccountType);

/** @internal */
export const BankAccountType$outboundSchema: z.ZodNativeEnum<typeof BankAccountType> =
