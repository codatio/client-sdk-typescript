 ...
 * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
 */
export type BankAccountsBankAccountType = ClosedEnum<typeof BankAccountsBankAccountType>;
...
/** @internal */
export const BankAccounts$inboundSchema: z.ZodType<BankAccounts, z.ZodTypeDef, unknown> = z
    .object({
        results: z.array(z.lazy(() => AccountingBankAccount$inboundSchema)).optional(),
...
> = z
    .object({
        results: z.array(z.lazy(() => AccountingBankAccount$outboundSchema)).optional(),
        pageNumber: z.number().int(),
        pageSize: z.number().int(),
        totalResults: z.number().int(),
