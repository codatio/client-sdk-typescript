...
export function BankTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankTransaction {
    ...
    return {
        ...
        ...(json['counterparty'] !== undefined ? { 'counterparty': json['counterparty'] } : {}),
        ...(json['reference'] !== undefined ? { 'reference': json['reference'] } : {}),
        ...(json['reconciled'] !== undefined ? { 'reconciled': json['reconciled'] } : {}),
        ...
        ...(json['transactionType'] !== undefined ? { 'transactionType': json['transactionType'] } : {}),
    };
}
