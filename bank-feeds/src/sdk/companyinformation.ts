...
export class CompanyInformation extends ClientSDK {
    ...
    async get(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCompanyInformationRequest$outboundSchema.parse(value$),
        ...
        const [result$] = await this.matcher<shared.CompanyInformation>()
            .json(200, shared.CompanyInformation$inboundSchema)
