        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getProfileSyncSettings200ApplicationJSONObject = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getProfileSyncSettings401ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  **/
  getSettingsProfile(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetSettingsProfileResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
          ...
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getSettingsProfile401ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  postProfileSyncSettings(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          ...
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.postProfileSyncSettings401ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  putProfile(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          ...
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.putProfile401ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
