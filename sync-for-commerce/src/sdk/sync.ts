...
export class Sync extends ClientSDK {
    ...
    async request(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.RequestSyncRequest$outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = encodeJSON$("body", payload$.SyncToLatestArgs, { explode: true });
        ...
        const [result$] = await this.matcher<shared.SyncSummary>()
            .json(200, shared.SyncSummary$inboundSchema)
    ...
    async requestForDateRange(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.RequestSyncForDateRangeRequest$outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = encodeJSON$("body", payload$.SyncRange, { explode: true });
    ...
    async getStatus(
        ...
        const [result$] = await this.matcher<shared.SyncStatus>()
            .json(200, shared.SyncStatus$inboundSchema)
