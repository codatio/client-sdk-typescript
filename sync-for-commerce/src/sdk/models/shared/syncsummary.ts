...
/** @internal */
export const SyncDateRangeUtc$inboundSchema: z.ZodType<SyncDateRangeUtc, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const SyncSummary$inboundSchema: z.ZodType<SyncSummary, z.ZodTypeDef, unknown> = z.object({
