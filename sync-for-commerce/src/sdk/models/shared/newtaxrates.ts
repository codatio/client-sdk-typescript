...
/** @internal */
export const NewTaxRates$inboundSchema: z.ZodType<
  NewTaxRates,
  z.ZodTypeDef,
  unknown
> = z.object({
  accountingTaxRateOptions: z.nullable(
    z.array(ConfigurationOption$inboundSchema),
  ).optional(),
  commerceTaxRateOptions: z.nullable(z.array(ConfigurationOption$inboundSchema))
    .optional(),
  ...
  defaultZeroTaxRateOptions: z.nullable(
    z.array(ConfigurationOption$inboundSchema),
  ).optional(),
});
...
export type NewTaxRates$Outbound = {
  accountingTaxRateOptions?:
    | Array<ConfigurationOption$Outbound>
    | null
    | undefined;
...
> = z.object({
  accountingTaxRateOptions: z.nullable(
    z.array(ConfigurationOption$outboundSchema),
  ).optional(),
  commerceTaxRateOptions: z.nullable(
    z.array(ConfigurationOption$outboundSchema),
  ).optional(),
  taxRateMappings: z.nullable(z.array(TaxRateMapping$outboundSchema))
    .optional(),
  selectedDefaultZeroTaxRateId: z.nullable(z.string()).optional(),
  defaultZeroTaxRateOptions: z.nullable(
    z.array(ConfigurationOption$outboundSchema),
...
export function newTaxRatesToJSON(newTaxRates: NewTaxRates): string {
  return JSON.stringify(NewTaxRates$outboundSchema.parse(newTaxRates));
}

export function newTaxRatesFromJSON(
  jsonString: string,
): SafeParseResult<NewTaxRates, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => NewTaxRates$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NewTaxRates' from JSON`,
  );
}
