...
/** @internal */
export const TaxRateAmount$inboundSchema: z.ZodType<
  TaxRateAmount,
  z.ZodTypeDef,
  unknown
> = z.object({
  selectedTaxRateId: z.nullable(z.string()).optional(),
  taxRateOptions: z.nullable(z.array(ConfigurationOption$inboundSchema))
    .optional(),
});
...
> = z.object({
  selectedTaxRateId: z.nullable(z.string()).optional(),
  taxRateOptions: z.nullable(z.array(ConfigurationOption$outboundSchema))
    .optional(),
});
...
export function taxRateAmountToJSON(taxRateAmount: TaxRateAmount): string {
  return JSON.stringify(TaxRateAmount$outboundSchema.parse(taxRateAmount));
}

export function taxRateAmountFromJSON(
  jsonString: string,
): SafeParseResult<TaxRateAmount, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TaxRateAmount$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TaxRateAmount' from JSON`,
  );
}
