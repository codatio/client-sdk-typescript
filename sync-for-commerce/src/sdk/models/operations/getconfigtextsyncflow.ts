...
export type GetConfigTextSyncFlowResponse = {
    /**
...
export namespace GetConfigTextSyncFlowRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetConfigTextSyncFlowRequest, z.ZodTypeDef, Inbound> = z
        .object({
            locale: shared.Locale$,
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetConfigTextSyncFlowRequest> = z
        .object({
            locale: shared.Locale$,
        })
        .transform((v) => {
...
/** @internal */
export namespace GetConfigTextSyncFlowResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<GetConfigTextSyncFlowResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetConfigTextSyncFlowResponse> =
        z
            .object({
                contentType: z.string(),
