...
export namespace SetConfigurationRequest$ {
    ...
    export const inboundSchema: z.ZodType<SetConfigurationRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, SetConfigurationRequest> = z
        .object({
            companyId: z.string(),
        })
        .transform((v) => {
...
export namespace SetConfigurationResponse$ {
    ...
    export const inboundSchema: z.ZodType<SetConfigurationResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, SetConfigurationResponse> = z
        .object({
