 ...
 */
export async function integrationsGetBranding(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIntegrationBrandingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/config/integrations/{platformKey}/branding")(
    pathParams,
  );
