 ...
 */
export async function syncRequestForDateRange(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RequestSyncForDateRangeRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/meta/companies/{companyId}/sync/commerce/historic")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.SyncSummary$inboundSchema),
    M.jsonErr(
