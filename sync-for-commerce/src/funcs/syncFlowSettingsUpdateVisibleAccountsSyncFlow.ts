 ...
 */
export async function syncFlowSettingsUpdateVisibleAccountsSyncFlow(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateVisibleAccountsSyncFlowRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.VisibleAccounts$inboundSchema),
    M.jsonErr(
