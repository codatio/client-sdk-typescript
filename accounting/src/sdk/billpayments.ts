...
export class BillPayments {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.createBillPayment200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  **/
  deleteCompaniesCompanyIdConnectionsConnectionIdPushBillPaymentsBillPaymentId(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DeleteCompaniesCompanyIdConnectionsConnectionIdPushBillPaymentsBillPaymentIdRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/companies/{companyId}/connections/{connectionId}/push/billPayments/{billPaymentId}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.deleteCompaniesCompanyIdConnectionsConnectionIdPushBillPaymentsBillPaymentId200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  **/
  getCreateBillPaymentsModel(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/companies/{companyId}/connections/{connectionId}/options/billPayments", req.pathParams);
