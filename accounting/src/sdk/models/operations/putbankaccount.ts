...
export class PutBankAccount200ApplicationJSONValidation extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=errors", elemType: PutBankAccount200ApplicationJSONValidationValidationItem })
  errors?: PutBankAccount200ApplicationJSONValidationValidationItem[];

  @SpeakeasyMetadata({ data: "json, name=warnings", elemType: PutBankAccount200ApplicationJSONValidationValidationItem })
...
export class PutBankAccount200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=changes", elemType: PutBankAccount200ApplicationJSONChanges })
