...
export class ListTaxRatesLinksResults extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=components", elemType: ListTaxRatesLinksResultsComponents })
  ...
  @SpeakeasyMetadata({ data: "json, name=validDatatypeLinks", elemType: ListTaxRatesLinksResultsValidDataTypeLinks })
...
export class ListTaxRatesLinks extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=results", elemType: ListTaxRatesLinksResults })
