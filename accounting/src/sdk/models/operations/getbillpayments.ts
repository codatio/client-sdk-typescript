...
export class GetBillPaymentsPathParams extends SpeakeasyBase {
...
**/
export class GetBillPaymentsSourceModifiedDateAccountRef extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "id" })
  id?: string;
...
export enum GetBillPaymentsSourceModifiedDateLinesLinksTypeEnum {
    Unknown = "Unknown",
    Unlinked = "Unlinked",
    Bill = "Bill",
    Other = "Other",
...
export class GetBillPaymentsSourceModifiedDateLinesLinks extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "amount" })
  amount?: number;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "type" })
  type: GetBillPaymentsSourceModifiedDateLinesLinksTypeEnum;
}

export class GetBillPaymentsSourceModifiedDateLines extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: GetBillPaymentsSourceModifiedDateLinesLinks })
  @Expose({ name: "links" })
  @Type(() => GetBillPaymentsSourceModifiedDateLinesLinks)
  links?: GetBillPaymentsSourceModifiedDateLinesLinks[];
}

export class GetBillPaymentsSourceModifiedDateMetadata extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetBillPaymentsSourceModifiedDateSupplementalData extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "content" })
 ...
 * 
**/
export class GetBillPaymentsSourceModifiedDate extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "accountRef" })
  @Type(() => GetBillPaymentsSourceModifiedDateAccountRef)
  accountRef?: GetBillPaymentsSourceModifiedDateAccountRef;
  ...
  @SpeakeasyMetadata({ elemType: GetBillPaymentsSourceModifiedDateLines })
  @Expose({ name: "lines" })
  @Type(() => GetBillPaymentsSourceModifiedDateLines)
  lines?: GetBillPaymentsSourceModifiedDateLines[];

  @SpeakeasyMetadata()
  @Expose({ name: "metadata" })
  @Type(() => GetBillPaymentsSourceModifiedDateMetadata)
  metadata?: GetBillPaymentsSourceModifiedDateMetadata;
  ...
  @Type(() => GetBillPaymentsSourceModifiedDatePaymentMethodRef)
  paymentMethodRef?: GetBillPaymentsSourceModifiedDatePaymentMethodRef;
  ...
  @Type(() => GetBillPaymentsSourceModifiedDateSupplementalData)
  supplementalData?: GetBillPaymentsSourceModifiedDateSupplementalData;

  @SpeakeasyMetadata()
  @Expose({ name: "supplierRef" })
  @Type(() => GetBillPaymentsSourceModifiedDateSupplierRef)
  supplierRef?: GetBillPaymentsSourceModifiedDateSupplierRef;
