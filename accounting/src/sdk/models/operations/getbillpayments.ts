...
export class GetBillPaymentsSourceModifiedDateLines extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=links", elemType: GetBillPaymentsSourceModifiedDateLinesLinks })
...
export class GetBillPaymentsSourceModifiedDate extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=lines", elemType: GetBillPaymentsSourceModifiedDateLines })
