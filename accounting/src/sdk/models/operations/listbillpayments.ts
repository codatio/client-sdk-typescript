...
export class ListBillPaymentsSecurity extends SpeakeasyBase {
...
export class ListBillPaymentsLinksSourceModifiedDateLines extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=links", elemType: ListBillPaymentsLinksSourceModifiedDateLinesLinks })
...
export class ListBillPaymentsLinksSourceModifiedDate extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=lines", elemType: ListBillPaymentsLinksSourceModifiedDateLines })
...
export class ListBillPaymentsLinks extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=results", elemType: ListBillPaymentsLinksSourceModifiedDate })
