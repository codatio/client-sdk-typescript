...
export class ListPaymentsLinksSourceModifiedDateLines extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=links", elemType: ListPaymentsLinksSourceModifiedDateLinesLinks })
...
export class ListPaymentsLinksSourceModifiedDate extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=lines", elemType: ListPaymentsLinksSourceModifiedDateLines })
...
export class ListPaymentsLinks extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=results", elemType: ListPaymentsLinksSourceModifiedDate })
