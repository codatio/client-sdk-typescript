 ...
 */
export class GetTaxRate200ApplicationJSONTaxRateComponent extends SpeakeasyBase {
  /**
...
export class GetTaxRate200ApplicationJSON extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: GetTaxRate200ApplicationJSONTaxRateComponent })
  @Expose({ name: "components" })
  @Type(() => GetTaxRate200ApplicationJSONTaxRateComponent)
  components?: GetTaxRate200ApplicationJSONTaxRateComponent[];
