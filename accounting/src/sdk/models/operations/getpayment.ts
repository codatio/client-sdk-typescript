...
export class GetPaymentSourceModifiedDateLines extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=links", elemType: GetPaymentSourceModifiedDateLinesLinks })
...
export class GetPaymentSourceModifiedDate extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=lines", elemType: GetPaymentSourceModifiedDateLines })
