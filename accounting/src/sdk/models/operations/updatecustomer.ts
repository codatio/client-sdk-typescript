...
export class UpdateCustomerSourceModifiedDateContacts extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: UpdateCustomerSourceModifiedDateContactsPhone })
  @Expose({ name: "phone" })
...
export class UpdateCustomer200ApplicationJSONSourceModifiedDateContacts extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: UpdateCustomer200ApplicationJSONSourceModifiedDateContactsPhone })
  @Expose({ name: "phone" })
...
export class UpdateCustomer200ApplicationJSONSourceModifiedDate extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: UpdateCustomer200ApplicationJSONSourceModifiedDateAddresses })
  @Expose({ name: "addresses" })
  ...
  @SpeakeasyMetadata({ elemType: UpdateCustomer200ApplicationJSONSourceModifiedDateContacts })
  @Expose({ name: "contacts" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "supplementalData" })
  @Type(() => UpdateCustomer200ApplicationJSONSourceModifiedDateSupplementalData)
...
export class UpdateCustomer200ApplicationJSONValidation extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: UpdateCustomer200ApplicationJSONValidationValidationItem })
  @Expose({ name: "errors" })
