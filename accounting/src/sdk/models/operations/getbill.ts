...
export class GetBillSourceModifiedDatePurchaseOrderRef extends SpeakeasyBase {
  /**
...
export class GetBillSourceModifiedDate extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: GetBillSourceModifiedDatePurchaseOrderRef })
  @Expose({ name: "purchaseOrderRefs" })
  @Type(() => GetBillSourceModifiedDatePurchaseOrderRef)
  purchaseOrderRefs?: GetBillSourceModifiedDatePurchaseOrderRef[];
