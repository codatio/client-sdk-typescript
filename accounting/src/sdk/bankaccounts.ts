...
export class BankAccounts {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.createBankAccount200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  getAllBankAccount(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.getAllBankAccount200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
  ...
  **/
  getCreateUpdateBankAccountsModel(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/companies/{companyId}/connections/{connectionId}/options/bankAccounts", req.pathParams);
  ...
  putBankAccount(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.putBankAccount200ApplicationJSONObject = utils.deserializeJSONResponse(
                httpRes?.data,
