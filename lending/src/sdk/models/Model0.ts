...
/**
 * Check if a given object implements the Model0 interface.
 */
export function instanceOfModel0(value: object): value is Model0 {
    if (!('id' in value) || value['id'] === undefined) return false;
    return true;
}

export function Model0FromJSON(json: any): Model0 {
    return Model0FromJSONTyped(json, false);
}

export function Model0FromJSONTyped(json: any, ignoreDiscriminator: boolean): Model0 {
    if (json == null) {
        return json;
    }
    return {
...
export function Model0ToJSON(json: any): Model0 {
    return Model0ToJSONTyped(json, false);
}

export function Model0ToJSONTyped(value?: Model0 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
