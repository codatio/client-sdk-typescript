...
/**
 * @type GetReportStatusReportIdParameter
 * 
 * @export
 */
export type GetReportStatusReportIdParameter = string;

export function GetReportStatusReportIdParameterFromJSON(json: any): GetReportStatusReportIdParameter {
    return GetReportStatusReportIdParameterFromJSONTyped(json, false);
}

export function GetReportStatusReportIdParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetReportStatusReportIdParameter {
    if (json == null) {
        return json;
    }
...
export function GetReportStatusReportIdParameterToJSON(json: any): any {
    return GetReportStatusReportIdParameterToJSONTyped(json, false);
}

export function GetReportStatusReportIdParameterToJSONTyped(value?: GetReportStatusReportIdParameter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
