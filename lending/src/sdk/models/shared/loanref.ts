...
/**
 * Check if a given object implements the LoanRef interface.
 */
export function instanceOfLoanRef(value: object): value is LoanRef {
    return true;
}

export function LoanRefFromJSON(json: any): LoanRef {
    return LoanRefFromJSONTyped(json, false);
}

export function LoanRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoanRef {
    if (json == null) {
        return json;
    }
    return {
...
export function LoanRefToJSON(json: any): LoanRef {
    return LoanRefToJSONTyped(json, false);
}

export function LoanRefToJSONTyped(value?: LoanRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export interface LoanTransactionsLoanRef {
    /**
     * The id of the object being referred to.
     * @type {string}
     * @memberof LoanRef
