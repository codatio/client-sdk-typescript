...
import type { ReportOperation } from './reportoperation';
import {
    ReportOperationFromJSON,
    ReportOperationFromJSONTyped,
    ReportOperationToJSON,
    ReportOperationToJSONTyped,
...
export interface Reports {
    ...
    /**
     * 
     * @type {Array<ReportOperation>}
     * @memberof Reports
     */
    results?: Array<ReportOperation>;
}
...
export function ReportsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Reports {
    ...
    return {
        ...
        ...(json['results'] !== undefined ? { 'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(ReportOperationFromJSON)) } : {}),
    };
}

export function ReportsToJSON(json: any): Reports {
    return ReportsToJSONTyped(json, false);
}

export function ReportsToJSONTyped(value?: Reports | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(ReportOperationToJSON)),
    };
}


export interface ListReportsResponseReports {
    /**
     * Current page number.
     * @type {number}
     * @memberof Reports
...
export interface ReportsListResponseReports {
    /**
     * Current page number.
     * @type {number}
     * @memberof Reports
