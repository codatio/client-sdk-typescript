...
export namespace DirectCostPrototype$ {
  /** @deprecated use `DirectCostPrototype$inboundSchema` instead. */
  export const inboundSchema = DirectCostPrototype$inboundSchema;
  /** @deprecated use `DirectCostPrototype$outboundSchema` instead. */
