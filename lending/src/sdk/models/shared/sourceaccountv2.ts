 ...
 * Status of the source account.
 */
export type SourceAccountV2Status = ClosedEnum<typeof SourceAccountV2Status>;
...
export type SourceAccountV2 = {
   ...
   * Status of the source account.
   */
  status?: SourceAccountV2Status | null | undefined;
  /**
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace SourceAccountV2Status$ {
  /** @deprecated use `SourceAccountV2Status$inboundSchema` instead. */
  export const inboundSchema = SourceAccountV2Status$inboundSchema;
  /** @deprecated use `SourceAccountV2Status$outboundSchema` instead. */
  export const outboundSchema = SourceAccountV2Status$outboundSchema;
}
