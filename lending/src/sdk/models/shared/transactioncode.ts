...
export function instanceOfTransactionCode(value: any): boolean {
    for (const key in TransactionCode) {
        if (Object.prototype.hasOwnProperty.call(TransactionCode, key)) {
            if (TransactionCode[key as keyof typeof TransactionCode] === value) {
                return true;
            }
        }
    }
...
export function TransactionCodeToJSONTyped(value: any, ignoreDiscriminator: boolean): TransactionCode {
    return value as TransactionCode;
}
