...
export function ProductVariantFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariant {
    ...
    return {
        ...
        'isTaxEnabled': json['isTaxEnabled'] == null ? undefined : json['isTaxEnabled'],
        ...
        'vatPercentage': json['vatPercentage'] == null ? undefined : toDecimal(json['vatPercentage']),
        'prices': json['prices'] == null ? undefined : ((json['prices'] as Array<any>).map(ProductPriceFromJSON)),
        'inventory': json['inventory'] == null ? undefined : ProductInventoryFromJSON(json['inventory']),
        'shippingRequired': json['shippingRequired'] == null ? undefined : json['shippingRequired'],
        'status': json['status'] == null ? undefined : ProductVariantStatusFromJSON(json['status']),
    };
}
