...
export type ReportBasis = typeof ReportBasis[keyof typeof ReportBasis];


export function instanceOfReportBasis(value: any): boolean {
    for (const key in ReportBasis) {
        if (Object.prototype.hasOwnProperty.call(ReportBasis, key)) {
            if (ReportBasis[key as keyof typeof ReportBasis] === value) {
                return true;
            }
        }
    }
...
export function ReportBasisFromJSON(json: any): ReportBasis {
    return ReportBasisFromJSONTyped(json, false);
}

export function ReportBasisFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReportBasis {
    return json as ReportBasis;
}

export function ReportBasisToJSON(value?: ReportBasis | null): any {
    return value as any;
}

export function ReportBasisToJSONTyped(value: any, ignoreDiscriminator: boolean): ReportBasis {
    return value as ReportBasis;
}
