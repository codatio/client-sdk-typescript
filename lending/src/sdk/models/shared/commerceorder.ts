...
export function CommerceOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommerceOrder {
    ...
    return {
        ...
        'closedDate': json['closedDate'] == null ? undefined : json['closedDate'],
        'totalAmount': json['totalAmount'] == null ? undefined : toDecimal(json['totalAmount']),
        'totalRefund': json['totalRefund'] == null ? undefined : toDecimal(json['totalRefund']),
        'totalTaxAmount': json['totalTaxAmount'] == null ? undefined : toDecimal(json['totalTaxAmount']),
        'totalDiscount': json['totalDiscount'] == null ? undefined : toDecimal(json['totalDiscount']),
        'totalGratuity': json['totalGratuity'] == null ? undefined : toDecimal(json['totalGratuity']),
        'orderLineItems': json['orderLineItems'] == null ? undefined : ((json['orderLineItems'] as Array<any>).map(OrderLineItemFromJSON)),
        'payments': json['payments'] == null ? undefined : ((json['payments'] as Array<any>).map(PaymentRefFromJSON)),
        'serviceCharges': json['serviceCharges'] == null ? undefined : ((json['serviceCharges'] as Array<any>).map(ServiceChargeFromJSON)),
        'locationRef': json['locationRef'] == null ? undefined : LocationRefFromJSON(json['locationRef']),
        'customerRef': json['customerRef'] == null ? undefined : CommerceCustomerRefFromJSON(json['customerRef']),
