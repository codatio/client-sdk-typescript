...
/** @internal */
export const AccountingAgedCreditorReport$inboundSchema: z.ZodType<
...
export namespace AccountingAgedCreditorReport$ {
  /** @deprecated use `AccountingAgedCreditorReport$inboundSchema` instead. */
  export const inboundSchema = AccountingAgedCreditorReport$inboundSchema;
  /** @deprecated use `AccountingAgedCreditorReport$outboundSchema` instead. */
