...
import type { AgedCreditor } from './agedcreditor';
import {
    AgedCreditorFromJSON,
    AgedCreditorFromJSONTyped,
    AgedCreditorToJSON,
    AgedCreditorToJSONTyped,
} from './agedcreditor';
 ...
 * @export
 * @interface AccountingAgedCreditorReport
 */
export interface AccountingAgedCreditorReport {
    /**
     ...
     * @type {string}
     * @memberof AccountingAgedCreditorReport
     */
    generated?: string;
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     ...
     * @type {Array<AgedCreditor>}
     * @memberof AccountingAgedCreditorReport
     */
    data?: Array<AgedCreditor>;
}

/**
 * Check if a given object implements the AccountingAgedCreditorReport interface.
 */
export function instanceOfAccountingAgedCreditorReport(value: object): value is AccountingAgedCreditorReport {
    return true;
}

export function AccountingAgedCreditorReportFromJSON(json: any): AccountingAgedCreditorReport {
    return AccountingAgedCreditorReportFromJSONTyped(json, false);
}

export function AccountingAgedCreditorReportFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountingAgedCreditorReport {
    if (json == null) {
        return json;
    }
    return {
        
        ...(json['generated'] !== undefined ? { 'generated': json['generated'] == null ? undefined : json['generated'] } : {}),
        ...(json['reportDate'] !== undefined ? { 'reportDate': json['reportDate'] == null ? undefined : json['reportDate'] } : {}),
        ...(json['data'] !== undefined ? { 'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(AgedCreditorFromJSON)) } : {}),
    };
}

export function AccountingAgedCreditorReportToJSON(json: any): AccountingAgedCreditorReport {
    return AccountingAgedCreditorReportToJSONTyped(json, false);
}

export function AccountingAgedCreditorReportToJSONTyped(value?: AccountingAgedCreditorReport | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(AgedCreditorToJSON)),
    };
}


export interface AccountingAgedCreditorReportAccountingAgedCreditorsReport {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface AccountingAgedCreditorsReport {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface AccountingAgedCreditorsReportGetResponseAccountingAgedCreditorReport {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface AccountingAgedCreditorsReportGetResponseAccountingAgedCreditorsReport {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface GetAccountingAgedCreditorsReportResponseAccountingAgedCreditorReport {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface GetAccountingAgedCreditorsReportResponseAccountingAgedCreditorsReport {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
