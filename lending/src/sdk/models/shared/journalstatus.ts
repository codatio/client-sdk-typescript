...
export function instanceOfJournalStatus(value: any): boolean {
    for (const key in JournalStatus) {
        if (Object.prototype.hasOwnProperty.call(JournalStatus, key)) {
            if (JournalStatus[key as keyof typeof JournalStatus] === value) {
                return true;
            }
        }
    }
...
export function JournalStatusFromJSON(json: any): JournalStatus {
    return JournalStatusFromJSONTyped(json, false);
}

export function JournalStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalStatus {
    return json as JournalStatus;
}

export function JournalStatusToJSON(value?: JournalStatus | null): any {
    return value as any;
}

export function JournalStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): JournalStatus {
