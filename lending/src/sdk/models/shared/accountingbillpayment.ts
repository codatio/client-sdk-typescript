...
export function AccountingBillPaymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountingBillPayment {
    ...
    return {
        ...
        ...(json['supplierRef'] !== undefined ? { 'supplierRef': json['supplierRef'] == null ? undefined : AccountingBillPaymentAllOfSupplierRefFromJSON(json['supplierRef']) } : {}),
        ...
        ...(json['paymentMethodRef'] !== undefined ? { 'paymentMethodRef': json['paymentMethodRef'] == null ? undefined : AccountingBillPaymentAllOfPaymentMethodRefFromJSON(json['paymentMethodRef']) } : {}),
        ...(json['lines'] !== undefined ? { 'lines': json['lines'] == null ? json['lines'] : ((json['lines'] as Array<any>).map(BillPaymentLineFromJSON)) } : {}),
...
export function AccountingBillPaymentToJSONTyped(value?: AccountingBillPayment | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'lines': value['lines'] == null ? value['lines'] : ((value['lines'] as Array<any>).map(BillPaymentLineToJSON)),
