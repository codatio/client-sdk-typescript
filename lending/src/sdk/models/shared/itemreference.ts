...
export interface AccountingBillCreditNoteItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface AccountingBillItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface AccountingCreditNoteItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface AccountingDirectCostItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface AccountingDirectIncomeItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface AccountingInvoiceItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface LoanSummaryItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
...
export interface LoanTransactionsItemReference {
    /**
     * Unique identifier for the item in the accounting software.
     * @type {string}
     * @memberof ItemReference
