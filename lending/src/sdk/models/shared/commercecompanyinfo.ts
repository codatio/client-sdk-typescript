...
export function CommerceCompanyInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommerceCompanyInfo {
    ...
    return {
        ...
        'commercePlatformRef': json['commercePlatformRef'] == null ? undefined : json['commercePlatformRef'],
        'companyLegalName': json['companyLegalName'] == null ? undefined : json['companyLegalName'],
        'addresses': json['addresses'] == null ? undefined : ((json['addresses'] as Array<any>).map(CommerceAddressFromJSON)),
        ...
        'accountBalances': json['accountBalances'] == null ? undefined : ((json['accountBalances'] as Array<any>).map(AccountBalanceFromJSON)),
