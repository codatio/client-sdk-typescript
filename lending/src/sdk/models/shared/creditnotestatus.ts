...
export function instanceOfCreditNoteStatus(value: any): boolean {
    for (const key in CreditNoteStatus) {
        if (Object.prototype.hasOwnProperty.call(CreditNoteStatus, key)) {
            if (CreditNoteStatus[key as keyof typeof CreditNoteStatus] === value) {
                return true;
            }
        }
    }
...
export function CreditNoteStatusFromJSON(json: any): CreditNoteStatus {
    return CreditNoteStatusFromJSONTyped(json, false);
}

export function CreditNoteStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditNoteStatus {
    return json as CreditNoteStatus;
}

export function CreditNoteStatusToJSON(value?: CreditNoteStatus | null): any {
    return value as any;
}

export function CreditNoteStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): CreditNoteStatus {
