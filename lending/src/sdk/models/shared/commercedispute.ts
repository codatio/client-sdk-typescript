...
export function CommerceDisputeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommerceDispute {
    ...
    return {
        ...
        'disputedTransactions': json['disputedTransactions'] == null ? undefined : ((json['disputedTransactions'] as Array<any>).map(TransactionSourceRefFromJSON)),
        'totalAmount': json['totalAmount'] == null ? undefined : toDecimal(json['totalAmount']),
        'currency': json['currency'],
        'status': json['status'] == null ? undefined : DisputeStatusFromJSON(json['status']),
