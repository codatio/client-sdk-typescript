...
/** @internal */
export const AccountingPayment$inboundSchema: z.ZodType<
  AccountingPayment,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type AccountingPayment$Outbound = {
  modifiedDate?: string | undefined;
  sourceModifiedDate?: string | undefined;
  id?: string | undefined;
...
/** @internal */
export const AccountingPayment$outboundSchema: z.ZodType<
...
export namespace AccountingPayment$ {
  /** @deprecated use `AccountingPayment$inboundSchema` instead. */
  export const inboundSchema = AccountingPayment$inboundSchema;
  /** @deprecated use `AccountingPayment$outboundSchema` instead. */
  export const outboundSchema = AccountingPayment$outboundSchema;
  /** @deprecated use `AccountingPayment$Outbound` instead. */
  export type Outbound = AccountingPayment$Outbound;
}

export function accountingPaymentToJSON(
  accountingPayment: AccountingPayment,
): string {
  return JSON.stringify(
    AccountingPayment$outboundSchema.parse(accountingPayment),
  );
}

export function accountingPaymentFromJSON(
  jsonString: string,
): SafeParseResult<AccountingPayment, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AccountingPayment$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AccountingPayment' from JSON`,
  );
}
