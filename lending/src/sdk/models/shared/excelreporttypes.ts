...
export type ExcelReportTypes = typeof ExcelReportTypes[keyof typeof ExcelReportTypes];


export function instanceOfExcelReportTypes(value: any): boolean {
    for (const key in ExcelReportTypes) {
        if (Object.prototype.hasOwnProperty.call(ExcelReportTypes, key)) {
            if (ExcelReportTypes[key as keyof typeof ExcelReportTypes] === value) {
                return true;
            }
        }
    }
...
export function ExcelReportTypesFromJSON(json: any): ExcelReportTypes {
    return ExcelReportTypesFromJSONTyped(json, false);
}

export function ExcelReportTypesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExcelReportTypes {
    return json as ExcelReportTypes;
}

export function ExcelReportTypesToJSON(value?: ExcelReportTypes | null): any {
    return value as any;
}

export function ExcelReportTypesToJSONTyped(value: any, ignoreDiscriminator: boolean): ExcelReportTypes {
    return value as ExcelReportTypes;
}
