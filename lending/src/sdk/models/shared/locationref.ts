...
export function LocationRefToJSON(json: any): LocationRef {
    return LocationRefToJSONTyped(json, false);
}

export function LocationRefToJSONTyped(value?: LocationRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export interface CommerceOrderGetResponseLocationRef {
    /**
     * The unique identitifer of the location being referenced.
     * @type {string}
     * @memberof LocationRef
...
export interface CommerceOrderLocationRef {
    /**
     * The unique identitifer of the location being referenced.
     * @type {string}
     * @memberof LocationRef
...
export interface CommerceOrdersLocationRef {
    /**
     * The unique identitifer of the location being referenced.
     * @type {string}
     * @memberof LocationRef
...
export interface GetCommerceOrderResponseLocationRef {
    /**
     * The unique identitifer of the location being referenced.
     * @type {string}
     * @memberof LocationRef
