...
export function instanceOfProductVariantStatus(value: any): boolean {
    for (const key in ProductVariantStatus) {
        if (Object.prototype.hasOwnProperty.call(ProductVariantStatus, key)) {
            if (ProductVariantStatus[key as keyof typeof ProductVariantStatus] === value) {
                return true;
            }
        }
    }
...
export function ProductVariantStatusFromJSON(json: any): ProductVariantStatus {
    return ProductVariantStatusFromJSONTyped(json, false);
}

export function ProductVariantStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariantStatus {
    return json as ProductVariantStatus;
}

export function ProductVariantStatusToJSON(value?: ProductVariantStatus | null): any {
    return value as any;
}

export function ProductVariantStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ProductVariantStatus {
    return value as ProductVariantStatus;
}
