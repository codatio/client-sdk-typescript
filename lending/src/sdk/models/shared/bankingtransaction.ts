...
import type { TransactionCategoryRef } from './transactioncategoryref';
import {
    TransactionCategoryRefFromJSON,
    TransactionCategoryRefFromJSONTyped,
    TransactionCategoryRefToJSON,
    TransactionCategoryRefToJSONTyped,
} from './transactioncategoryref';
import type { TransactionCode } from './transactioncode';
import {
    TransactionCodeFromJSON,
    TransactionCodeFromJSONTyped,
    TransactionCodeToJSON,
    TransactionCodeToJSONTyped,
...
/**
 * Check if a given object implements the BankingTransaction interface.
 */
export function instanceOfBankingTransaction(value: object): value is BankingTransaction {
...
export function BankingTransactionFromJSON(json: any): BankingTransaction {
    return BankingTransactionFromJSONTyped(json, false);
}

export function BankingTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankingTransaction {
    if (json == null) {
        return json;
    }
    return {
        ...
        ...(json['postedDate'] !== undefined ? { 'postedDate': json['postedDate'] == null ? undefined : json['postedDate'] } : {}),
        ...(json['authorizedDate'] !== undefined ? { 'authorizedDate': json['authorizedDate'] == null ? undefined : json['authorizedDate'] } : {}),
        ...(json['code'] !== undefined ? { 'code': json['code'] == null ? undefined : TransactionCodeFromJSON(json['code']) } : {}),
        ...(json['merchantName'] !== undefined ? { 'merchantName': json['merchantName'] } : {}),
        ...(json['transactionCategoryRef'] !== undefined ? { 'transactionCategoryRef': json['transactionCategoryRef'] == null ? undefined : TransactionCategoryRefFromJSON(json['transactionCategoryRef']) } : {}),
    };
}

export function BankingTransactionToJSON(json: any): BankingTransaction {
    return BankingTransactionToJSONTyped(json, false);
}

export function BankingTransactionToJSONTyped(value?: BankingTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'transactionCategoryRef': TransactionCategoryRefToJSON(value['transactionCategoryRef']),
    };
}


export interface BankingTransactionGetResponseBankingTransaction {
    /**
     * The date when the record was last fetched from the accounting software, commerce software, or open banking provider and updated in Codat’s data cache.
     * 
     * Use it to identify and retrieve records that have changed since your last fetch. For example, filtering `modifiedDate` to today will provide new records updated in Codat today.
...
export interface BankingTransactionsBankingTransaction {
    /**
     * The date when the record was last fetched from the accounting software, commerce software, or open banking provider and updated in Codat’s data cache.
     * 
     * Use it to identify and retrieve records that have changed since your last fetch. For example, filtering `modifiedDate` to today will provide new records updated in Codat today.
...
export interface BankingTransactionsListResponseBankingTransaction {
    /**
     * The date when the record was last fetched from the accounting software, commerce software, or open banking provider and updated in Codat’s data cache.
     * 
     * Use it to identify and retrieve records that have changed since your last fetch. For example, filtering `modifiedDate` to today will provide new records updated in Codat today.
...
export interface GetBankingTransactionResponseBankingTransaction {
    /**
     * The date when the record was last fetched from the accounting software, commerce software, or open banking provider and updated in Codat’s data cache.
     * 
     * Use it to identify and retrieve records that have changed since your last fetch. For example, filtering `modifiedDate` to today will provide new records updated in Codat today.
...
export interface ListBankingTransactionsResponseBankingTransaction {
    /**
     * The date when the record was last fetched from the accounting software, commerce software, or open banking provider and updated in Codat’s data cache.
     * 
     * Use it to identify and retrieve records that have changed since your last fetch. For example, filtering `modifiedDate` to today will provide new records updated in Codat today.
...
export interface UploadBankStatementDataRequestBodyBankingTransaction {
    /**
     * The date when the record was last fetched from the accounting software, commerce software, or open banking provider and updated in Codat’s data cache.
     * 
     * Use it to identify and retrieve records that have changed since your last fetch. For example, filtering `modifiedDate` to today will provide new records updated in Codat today.
