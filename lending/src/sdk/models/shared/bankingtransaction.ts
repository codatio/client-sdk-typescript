...
export function BankingTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankingTransaction {
    ...
    return {
        ...
        'postedDate': json['postedDate'] == null ? undefined : json['postedDate'],
        'authorizedDate': json['authorizedDate'] == null ? undefined : json['authorizedDate'],
        'code': json['code'] == null ? undefined : TransactionCodeFromJSON(json['code']),
        'merchantName': json['merchantName'] == null ? undefined : json['merchantName'],
        'transactionCategoryRef': json['transactionCategoryRef'] == null ? undefined : TransactionCategoryRefFromJSON(json['transactionCategoryRef']),
    };
}
