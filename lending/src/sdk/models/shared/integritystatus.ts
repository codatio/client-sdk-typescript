...
export function instanceOfIntegrityStatus(value: any): boolean {
    for (const key in IntegrityStatus) {
        if (Object.prototype.hasOwnProperty.call(IntegrityStatus, key)) {
            if (IntegrityStatus[key as keyof typeof IntegrityStatus] === value) {
                return true;
            }
        }
    }
...
export function IntegrityStatusFromJSON(json: any): IntegrityStatus {
    return IntegrityStatusFromJSONTyped(json, false);
}

export function IntegrityStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IntegrityStatus {
    return json as IntegrityStatus;
}

export function IntegrityStatusToJSON(value?: IntegrityStatus | null): any {
    return value as any;
}

export function IntegrityStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): IntegrityStatus {
