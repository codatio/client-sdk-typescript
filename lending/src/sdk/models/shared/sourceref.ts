...
export interface CashFlowTransactionSourceRef {
    /**
     * The data source type.
     * @type {string}
     * @memberof SourceRef
...
export interface CategorizedBankStatementAccountsSourceRef {
    /**
     * The data source type.
     * @type {string}
     * @memberof SourceRef
...
export interface CategorizedBankStatementTransactionsSourceRef {
    /**
     * The data source type.
     * @type {string}
     * @memberof SourceRef
