...
/**
 * Check if a given object implements the JournalRef interface.
 */
export function instanceOfJournalRef(value: object): value is JournalRef {
    if (!('id' in value) || value['id'] === undefined) return false;
    return true;
}

export function JournalRefFromJSON(json: any): JournalRef {
    return JournalRefFromJSONTyped(json, false);
}

export function JournalRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalRef {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalRefToJSON(json: any): JournalRef {
    return JournalRefToJSONTyped(json, false);
}

export function JournalRefToJSONTyped(value?: JournalRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export interface AccountingJournalEntriesJournalRef {
    [key: string]: any | any;
    /**
     * GUID of the underlying journal.
     * @type {string}
...
export interface AccountingJournalEntryGetResponseJournalRef {
    [key: string]: any | any;
    /**
     * GUID of the underlying journal.
     * @type {string}
...
export interface AccountingJournalEntryJournalRef {
    [key: string]: any | any;
    /**
     * GUID of the underlying journal.
     * @type {string}
...
export interface GetAccountingJournalEntryResponseJournalRef {
    [key: string]: any | any;
    /**
     * GUID of the underlying journal.
     * @type {string}
