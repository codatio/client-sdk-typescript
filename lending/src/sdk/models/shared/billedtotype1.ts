...
export type BilledToType1 = typeof BilledToType1[keyof typeof BilledToType1];


export function instanceOfBilledToType1(value: any): boolean {
    for (const key in BilledToType1) {
        if (Object.prototype.hasOwnProperty.call(BilledToType1, key)) {
            if (BilledToType1[key as keyof typeof BilledToType1] === value) {
                return true;
            }
        }
    }
...
export function BilledToType1FromJSON(json: any): BilledToType1 {
    return BilledToType1FromJSONTyped(json, false);
}

export function BilledToType1FromJSONTyped(json: any, ignoreDiscriminator: boolean): BilledToType1 {
    return json as BilledToType1;
}

export function BilledToType1ToJSON(value?: BilledToType1 | null): any {
    return value as any;
}

export function BilledToType1ToJSONTyped(value: any, ignoreDiscriminator: boolean): BilledToType1 {
    return value as BilledToType1;
}
