...
/**
 * Check if a given object implements the PaymentRef interface.
 */
export function instanceOfPaymentRef(value: object): value is PaymentRef {
    if (!('id' in value) || value['id'] === undefined) return false;
    return true;
}

export function PaymentRefFromJSON(json: any): PaymentRef {
    return PaymentRefFromJSONTyped(json, false);
}

export function PaymentRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentRef {
    if (json == null) {
        return json;
    }
    return {
        ...
        ...(json['amount'] !== undefined ? { 'amount': json['amount'] == null ? json['amount'] : toDecimal(json['amount']) } : {}),
        ...(json['currency'] !== undefined ? { 'currency': json['currency'] == null ? undefined : json['currency'] } : {}),
        ...(json['type'] !== undefined ? { 'type': json['type'] == null ? json['type'] : PaymentTypeFromJSON(json['type']) } : {}),
...
export function PaymentRefToJSON(json: any): PaymentRef {
    return PaymentRefToJSONTyped(json, false);
}

export function PaymentRefToJSONTyped(value?: PaymentRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export interface CommerceOrderGetResponsePaymentRef {
    /**
     * A unique, persistent identifier for this record
     * @type {string}
     * @memberof PaymentRef
...
export interface CommerceOrderPaymentRef {
    /**
     * A unique, persistent identifier for this record
     * @type {string}
     * @memberof PaymentRef
...
export interface GetCommerceOrderResponsePaymentRef {
    /**
     * A unique, persistent identifier for this record
     * @type {string}
     * @memberof PaymentRef
