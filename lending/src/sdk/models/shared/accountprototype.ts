...
export namespace AccountPrototypeValidDataTypeLinks$ {
  /** @deprecated use `AccountPrototypeValidDataTypeLinks$inboundSchema` instead. */
  export const inboundSchema = AccountPrototypeValidDataTypeLinks$inboundSchema;
  /** @deprecated use `AccountPrototypeValidDataTypeLinks$outboundSchema` instead. */
  export const outboundSchema =
    AccountPrototypeValidDataTypeLinks$outboundSchema;
  /** @deprecated use `AccountPrototypeValidDataTypeLinks$Outbound` instead. */
  export type Outbound = AccountPrototypeValidDataTypeLinks$Outbound;
}
