...
export namespace AccountingCreateBankAccountTransactions$ {
  /** @deprecated use `AccountingCreateBankAccountTransactions$inboundSchema` instead. */
  export const inboundSchema =
    AccountingCreateBankAccountTransactions$inboundSchema;
  /** @deprecated use `AccountingCreateBankAccountTransactions$outboundSchema` instead. */
  export const outboundSchema =
    AccountingCreateBankAccountTransactions$outboundSchema;
  /** @deprecated use `AccountingCreateBankAccountTransactions$Outbound` instead. */
...
export namespace AccountingCreateBankTransactionsResponse$ {
  /** @deprecated use `AccountingCreateBankTransactionsResponse$inboundSchema` instead. */
  export const inboundSchema =
    AccountingCreateBankTransactionsResponse$inboundSchema;
  /** @deprecated use `AccountingCreateBankTransactionsResponse$outboundSchema` instead. */
  export const outboundSchema =
