...
export function ContactFromJSONTyped(json: any, ignoreDiscriminator: boolean): Contact {
    ...
    return {
        ...
        ...(json['phone'] !== undefined ? { 'phone': json['phone'] == null ? json['phone'] : ((json['phone'] as Array<any>).map(PhoneNumberFromJSON)) } : {}),
        ...(json['address'] !== undefined ? { 'address': json['address'] == null ? undefined : AccountingAddressFromJSON(json['address']) } : {}),
...
export function ContactToJSONTyped(value?: Contact | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'name': value['name'],
        'email': value['email'],
        'phone': value['phone'] == null ? value['phone'] : ((value['phone'] as Array<any>).map(PhoneNumberToJSON)),
