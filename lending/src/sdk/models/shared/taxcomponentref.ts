 ...
 * @export
 * @interface TaxComponentRef
 */
export interface TaxComponentRef {
    /**
     * The unique identitifer of the tax component being referenced.
     * @type {string}
     * @memberof TaxComponentRef
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the TaxComponentRef interface.
 */
export function instanceOfTaxComponentRef(value: object): value is TaxComponentRef {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function TaxComponentRefFromJSON(json: any): TaxComponentRef {
    return TaxComponentRefFromJSONTyped(json, false);
}

export function TaxComponentRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaxComponentRef {
    if (json == null) {
        return json;
    }
    return {
...
export function TaxComponentRefToJSON(json: any): TaxComponentRef {
    return TaxComponentRefToJSONTyped(json, false);
}

export function TaxComponentRefToJSONTyped(value?: TaxComponentRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
