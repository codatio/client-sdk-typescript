...
export function BalanceSheetFromJSONTyped(json: any, ignoreDiscriminator: boolean): BalanceSheet {
    ...
    return {
        ...
        'assets': json['assets'] == null ? undefined : ReportLineFromJSON(json['assets']),
        'liabilities': json['liabilities'] == null ? undefined : ReportLineFromJSON(json['liabilities']),
        'netAssets': json['netAssets'],
        'equity': json['equity'] == null ? undefined : ReportLineFromJSON(json['equity']),
    };
}
