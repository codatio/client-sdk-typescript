...
export function AttachmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Attachments {
    ...
    return {
        ...
        ...(json['attachments'] !== undefined ? { 'attachments': json['attachments'] == null ? json['attachments'] : ((json['attachments'] as Array<any>).map(AccountingAttachmentFromJSON)) } : {}),
    };
}
...
export function AttachmentsToJSONTyped(value?: Attachments | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'attachments': value['attachments'] == null ? value['attachments'] : ((value['attachments'] as Array<any>).map(AccountingAttachmentToJSON)),
    };
}
