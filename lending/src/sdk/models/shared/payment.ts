...
export function PaymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): Payment {
    ...
    return {
        ...
        ...(json['paymentType'] !== undefined ? { 'paymentType': json['paymentType'] == null ? undefined : json['paymentType'] } : {}),
        ...
        ...(json['bankingTransactionRefs'] !== undefined ? { 'bankingTransactionRefs': json['bankingTransactionRefs'] == null ? undefined : ((json['bankingTransactionRefs'] as Array<any>).map(BankingTransactionRefFromJSON)) } : {}),
    };
}
