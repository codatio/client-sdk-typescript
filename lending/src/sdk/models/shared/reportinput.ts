...
export type ReportInput = typeof ReportInput[keyof typeof ReportInput];


export function instanceOfReportInput(value: any): boolean {
    for (const key in ReportInput) {
        if (Object.prototype.hasOwnProperty.call(ReportInput, key)) {
            if (ReportInput[key as keyof typeof ReportInput] === value) {
                return true;
            }
        }
    }
...
export function ReportInputFromJSON(json: any): ReportInput {
    return ReportInputFromJSONTyped(json, false);
}

export function ReportInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReportInput {
    return json as ReportInput;
}

export function ReportInputToJSON(value?: ReportInput | null): any {
    return value as any;
}

export function ReportInputToJSONTyped(value: any, ignoreDiscriminator: boolean): ReportInput {
