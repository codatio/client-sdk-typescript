...
export function JournalLineFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalLine {
    ...
    return {
        ...
        'transactionAmount': json['transactionAmount'] == null ? undefined : toDecimal(json['transactionAmount']),
        ...
        'tracking': json['tracking'] == null ? undefined : JournalLineTrackingFromJSON(json['tracking']),
        'contactRef': json['contactRef'] == null ? undefined : ContactReferenceFromJSON(json['contactRef']),
    };
}
