...
export function AccountingJournalEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountingJournalEntry {
    ...
    return {
        ...
        'postedOn': json['postedOn'] == null ? undefined : json['postedOn'],
        'createdOn': json['createdOn'] == null ? undefined : json['createdOn'],
        'updatedOn': json['updatedOn'] == null ? undefined : json['updatedOn'],
        'journalRef': json['journalRef'] == null ? undefined : JournalRefFromJSON(json['journalRef']),
        'journalLines': json['journalLines'] == null ? undefined : ((json['journalLines'] as Array<any>).map(JournalLineFromJSON)),
        'recordRef': json['recordRef'] == null ? undefined : JournalEntryRecordRefFromJSON(json['recordRef']),
...
export function AccountingJournalEntryToJSONTyped(value?: AccountingJournalEntry | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'journalLines': value['journalLines'] == null ? undefined : ((value['journalLines'] as Array<any>).map(JournalLineToJSON)),
