 ...
 */
export function instanceOfCashFlowStatement(value: object): value is CashFlowStatement {
    return true;
}
...
export function CashFlowStatementFromJSONTyped(json: any, ignoreDiscriminator: boolean): CashFlowStatement {
    ...
    return {
        ...
        ...(json['cashReceipts'] !== undefined ? { 'cashReceipts': json['cashReceipts'] == null ? undefined : ReportLineFromJSON(json['cashReceipts']) } : {}),
        ...(json['cashPayments'] !== undefined ? { 'cashPayments': json['cashPayments'] == null ? undefined : ReportLineFromJSON(json['cashPayments']) } : {}),
    };
}

export function CashFlowStatementToJSON(json: any): CashFlowStatement {
    return CashFlowStatementToJSONTyped(json, false);
}

export function CashFlowStatementToJSONTyped(value?: CashFlowStatement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'toDate': value['toDate'],
        'cashReceipts': ReportLineToJSON(value['cashReceipts']),
        'cashPayments': ReportLineToJSON(value['cashPayments']),
    };
}


export interface AccountingCashFlowStatementCashFlowStatement {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface AccountingCashFlowStatementGetResponseCashFlowStatement {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
...
export interface GetAccountingCashFlowStatementResponseCashFlowStatement {
    /**
     * In Codat's data model, dates and times are represented using the <a class="external" href="https://en.wikipedia.org/wiki/ISO_8601" target="_blank">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
     * 
     * ```
