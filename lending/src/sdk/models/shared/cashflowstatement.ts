...
export function CashFlowStatementFromJSONTyped(json: any, ignoreDiscriminator: boolean): CashFlowStatement {
    ...
    return {
        ...
        'cashReceipts': json['cashReceipts'] == null ? undefined : ReportLineFromJSON(json['cashReceipts']),
        'cashPayments': json['cashPayments'] == null ? undefined : ReportLineFromJSON(json['cashPayments']),
    };
}
