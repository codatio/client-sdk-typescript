...
/** @internal */
export const EnhancedCashFlowTransaction$inboundSchema: z.ZodType<
...
/** @internal */
export type EnhancedCashFlowTransaction$Outbound = {
  id?: string | undefined;
  date?: string | undefined;
  description?: string | undefined;
...
/** @internal */
export const EnhancedCashFlowTransaction$outboundSchema: z.ZodType<
...
export namespace EnhancedCashFlowTransaction$ {
  /** @deprecated use `EnhancedCashFlowTransaction$inboundSchema` instead. */
  export const inboundSchema = EnhancedCashFlowTransaction$inboundSchema;
  /** @deprecated use `EnhancedCashFlowTransaction$outboundSchema` instead. */
  export const outboundSchema = EnhancedCashFlowTransaction$outboundSchema;
  /** @deprecated use `EnhancedCashFlowTransaction$Outbound` instead. */
  export type Outbound = EnhancedCashFlowTransaction$Outbound;
}
