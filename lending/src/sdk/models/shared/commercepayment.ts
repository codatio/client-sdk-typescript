...
export function CommercePaymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommercePayment {
    ...
    return {
        ...
        ...(json['status'] !== undefined ? { 'status': json['status'] == null ? undefined : PaymentStatusFromJSON(json['status']) } : {}),
        ...(json['paymentProvider'] !== undefined ? { 'paymentProvider': json['paymentProvider'] == null ? undefined : json['paymentProvider'] } : {}),
