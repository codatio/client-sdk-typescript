...
import { CommerceRecordRef } from "./commercerecordref";
 ...
 */
export class CommerceProductCategory extends SpeakeasyBase {
    /**
     * A collection of parent product categories implicitly ordered with the immediate parent last in the list.
     */
    @SpeakeasyMetadata({ elemType: CommerceRecordRef })
    @Expose({ name: "ancestorRefs" })
    @Type(() => CommerceRecordRef)
    ancestorRefs?: CommerceRecordRef[];
