...
export class DownloadAccountingSupplierAttachmentRequest extends SpeakeasyBase {
    /**
...
export class DownloadAccountingSupplierAttachmentResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
