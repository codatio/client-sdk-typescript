 ...
 */
export async function liabilitiesListLoanTransactions(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListLoanTransactionsRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.LoanTransactions$inboundSchema),
    m$.jsonErr(
