 ...
 */
export async function bankingTransactionCategoriesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBankingTransactionCategoryRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    transactionCategoryId: encodeSimple(
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.BankingTransactionCategory$inboundSchema),
    M.jsonErr(
