 ...
 */
export async function transactionsTransfersGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingTransferRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingTransfer$inboundSchema),
    M.jsonErr(
