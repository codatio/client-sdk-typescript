...
type Call = CodatLending["transactions"]["directCosts"]["downloadAttachment"];
...
export function transactionsDirectCostsDownloadAttachment(
    ...
    return new APIPromise(toResult(() => client.transactions.directCosts.downloadAttachment(request, options)));
}
