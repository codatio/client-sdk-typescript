 ...
 */
export async function transactionsDirectCostsList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListAccountingDirectCostsRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.AccountingDirectCosts$inboundSchema),
    m$.jsonErr(
