 ...
 */
export async function bankingTransactionCategoriesList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBankingTransactionCategoriesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.BankingTransactionCategories$inboundSchema),
    M.jsonErr(
