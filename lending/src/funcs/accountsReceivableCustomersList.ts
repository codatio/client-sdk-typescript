 ...
 */
export async function accountsReceivableCustomersList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingCustomersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/data/customers")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCustomers$inboundSchema),
    M.jsonErr(
