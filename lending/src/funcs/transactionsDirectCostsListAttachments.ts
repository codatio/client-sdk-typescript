...
type Call = CodatLending["transactions"]["directCosts"]["listAttachments"];
...
export function transactionsDirectCostsListAttachments(
    ...
    return new APIPromise(toResult(() => client.transactions.directCosts.listAttachments(request, options)));
}
