 ...
 */
export async function manageReportsGenerateReport(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GenerateReportRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    reportType: encodeSimple("reportType", payload.reportType, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/companies/{companyId}/reports/{reportType}")(
    pathParams,
  );
