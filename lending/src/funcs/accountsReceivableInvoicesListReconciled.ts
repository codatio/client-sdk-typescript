 ...
 */
export async function accountsReceivableInvoicesListReconciled(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListReconciledInvoicesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/reports/enhancedInvoices")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.EnhancedInvoicesReport$inboundSchema),
    M.jsonErr(
