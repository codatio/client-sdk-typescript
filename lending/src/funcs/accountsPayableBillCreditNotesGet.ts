 ...
 */
export async function accountsPayableBillCreditNotesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingBillCreditNoteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingBillCreditNote$inboundSchema),
    M.jsonErr(
