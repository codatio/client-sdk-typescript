 ...
 */
export async function salesPaymentMethodsGet(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetCommercePaymentMethodRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.CommercePaymentMethod$inboundSchema),
    m$.jsonErr(
