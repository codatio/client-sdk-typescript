 ...
 */
export async function companyInfoGetCommerceProfile(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetCommerceProfileRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.CommerceCompanyInfo$inboundSchema),
    m$.jsonErr(
