 ...
 */
export async function transactionsAccountTransactionsList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingAccountTransactionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingAccountTransactions$inboundSchema),
    M.jsonErr(
