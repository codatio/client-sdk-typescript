 ...
 */
export async function loanWritebackSuppliersCreate(
...
> {
  ...
  const body = encodeJSON("body", payload.AccountingSupplier, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCreateSupplierResponse$inboundSchema),
    M.jsonErr(
