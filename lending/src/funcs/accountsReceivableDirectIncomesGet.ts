 ...
 */
export async function accountsReceivableDirectIncomesGet(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetAccountingDirectIncomeRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.AccountingDirectIncome$inboundSchema),
    m$.jsonErr(
