 ...
 */
export async function accountingBankDataAccountsList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListAccountingBankAccountsRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.AccountingBankAccounts$inboundSchema),
    m$.jsonErr(
