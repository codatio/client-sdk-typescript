 ...
 */
export async function loanWritebackCreateOperationsGet(
...
> {
  ...
  const pathParams = {
    ...
    pushOperationKey: encodeSimple(
      "pushOperationKey",
      payload.pushOperationKey,
      { explode: false, charEncoding: "percent" },
    ),
  };

  const path = pathToFunc("/companies/{companyId}/push/{pushOperationKey}")(
    pathParams,
  );
