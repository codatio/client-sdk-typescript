 ...
 */
export async function salesCustomersList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCommerceCustomersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.CommerceCustomers$inboundSchema),
    M.jsonErr(
