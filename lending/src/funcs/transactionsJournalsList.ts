 ...
 */
export async function transactionsJournalsList(
...
> {
  ...
  const path = pathToFunc("/companies/{companyId}/data/journals")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingJournals$inboundSchema),
    M.jsonErr(
