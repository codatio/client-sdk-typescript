...
type Call = CodatLending["financialStatements"]["balanceSheet"]["getCategorizedAccounts"];
...
export function financialStatementsBalanceSheetGetCategorizedAccounts(
    ...
    return new APIPromise(toResult(() => client.financialStatements.balanceSheet.getCategorizedAccounts(request, options)));
}
