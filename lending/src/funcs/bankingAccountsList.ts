 ...
 */
export async function bankingAccountsList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBankingAccountsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.BankingAccounts$inboundSchema),
    M.jsonErr(
