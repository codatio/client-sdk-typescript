 ...
 */
export async function accountsReceivablePaymentsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingPaymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/data/payments/{paymentId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingPayment$inboundSchema),
    M.jsonErr(
