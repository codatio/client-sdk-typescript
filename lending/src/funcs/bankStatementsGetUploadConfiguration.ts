...
type Call = CodatLending["bankStatements"]["getUploadConfiguration"];
...
export function bankStatementsGetUploadConfiguration(
    ...
    return new APIPromise(toResult(() => client.bankStatements.getUploadConfiguration(request, options)));
}
