 ...
 */
export async function transactionsDirectCostsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingDirectCostRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingDirectCost$inboundSchema),
    M.jsonErr(
