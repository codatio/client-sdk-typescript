 ...
 */
export async function salesTransactionsList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListCommerceTransactionsRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.CommerceTransactions$inboundSchema),
    m$.jsonErr(
