...
type Call = CodatLending["accountsReceivable"]["directIncomes"]["listAttachments"];
...
export function accountsReceivableDirectIncomesListAttachments(
    ...
    return new APIPromise(toResult(() => client.accountsReceivable.directIncomes.listAttachments(request, options)));
}
