 ...
 */
export async function accountsReceivableCreditNotesList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingCreditNotesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/data/creditNotes")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCreditNotes$inboundSchema),
    M.jsonErr(
