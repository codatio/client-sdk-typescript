 ...
 */
export async function accountsPayableBillCreditNotesList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingBillCreditNotesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/companies/{companyId}/data/billCreditNotes")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingBillCreditNotes$inboundSchema),
    M.jsonErr(
