...
type Call = CodatLending["accountsReceivable"]["reports"]["getAgedDebtors"];
...
export function accountsReceivableReportsGetAgedDebtors(
    ...
    return new APIPromise(toResult(() => client.accountsReceivable.reports.getAgedDebtors(request, options)));
}
