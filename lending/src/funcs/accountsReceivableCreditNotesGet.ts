 ...
 */
export async function accountsReceivableCreditNotesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingCreditNoteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCreditNote$inboundSchema),
    M.jsonErr(
