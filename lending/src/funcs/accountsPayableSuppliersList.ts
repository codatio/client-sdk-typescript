 ...
 */
export async function accountsPayableSuppliersList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListAccountingSuppliersRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/companies/{companyId}/data/suppliers")(
    pathParams$,
  );
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.AccountingSuppliers$inboundSchema),
    m$.jsonErr(
