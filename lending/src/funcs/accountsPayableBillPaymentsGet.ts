 ...
 */
export async function accountsPayableBillPaymentsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingBillPaymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingBillPayment$inboundSchema),
    M.jsonErr(
