 ...
 */
export async function accountsPayableBillPaymentsList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListAccountingBillPaymentsRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/companies/{companyId}/data/billPayments")(
    pathParams$,
  );
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.AccountingBillPayments$inboundSchema),
    m$.jsonErr(
