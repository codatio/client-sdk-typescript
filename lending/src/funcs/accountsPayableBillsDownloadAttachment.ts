...
type Call = CodatLending["accountsPayable"]["bills"]["downloadAttachment"];
...
export function accountsPayableBillsDownloadAttachment(
    ...
    return new APIPromise(toResult(() => client.accountsPayable.bills.downloadAttachment(request, options)));
}
