 ...
 */
export async function liabilitiesGenerateLoanSummary(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GenerateLoanSummaryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/reports/liabilities/loans")(
    pathParams,
  );
