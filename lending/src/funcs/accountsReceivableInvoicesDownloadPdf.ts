...
type Call = CodatLending["accountsReceivable"]["invoices"]["downloadPdf"];
...
export function accountsReceivableInvoicesDownloadPdf(
    ...
    return new APIPromise(toResult(() => client.accountsReceivable.invoices.downloadPdf(request, options)));
}
