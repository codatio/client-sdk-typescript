 ...
 */
export async function dataIntegritySummaries(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDataIntegritySummariesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.DataIntegritySummaries$inboundSchema),
    M.jsonErr(
