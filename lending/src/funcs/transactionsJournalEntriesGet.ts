 ...
 */
export async function transactionsJournalEntriesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingJournalEntryRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingJournalEntry$inboundSchema),
    M.jsonErr(
