 ...
 */
export async function accountsReceivableInvoicesList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingInvoicesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/data/invoices")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingInvoices$inboundSchema),
    M.jsonErr(
