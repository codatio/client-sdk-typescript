 ...
 */
export async function financialStatementsCashFlowGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingCashFlowStatementRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCashFlowStatement$inboundSchema),
    M.jsonErr(
