 ...
 */
export async function loanWritebackDirectCostsCreate(
...
> {
  ...
  const body$ = encodeJSON$("body", payload$.directCostPrototype, {
    explode: true,
  });
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.AccountingCreateDirectCostResponse$inboundSchema),
    m$.jsonErr(
