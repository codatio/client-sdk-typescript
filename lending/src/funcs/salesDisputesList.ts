 ...
 */
export async function salesDisputesList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListCommerceDisputesRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.CommerceDisputes$inboundSchema),
    m$.jsonErr(
