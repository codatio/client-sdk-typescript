 ...
 */
export async function accountsReceivableDirectIncomesList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingDirectIncomesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingDirectIncomes$inboundSchema),
    M.jsonErr(
