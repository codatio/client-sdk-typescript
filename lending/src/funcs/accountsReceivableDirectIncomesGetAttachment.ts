 ...
 */
export async function accountsReceivableDirectIncomesGetAttachment(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingDirectIncomeAttachmentRequest$outboundSchema
        .parse(value),
  ...
  const pathParams = {
    ...
    directIncomeId: encodeSimple("directIncomeId", payload.directIncomeId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
