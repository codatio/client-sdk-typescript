 ...
 */
export async function bankingAccountBalancesList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListBankingAccountBalancesRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.BankingAccountBalances$inboundSchema),
    m$.jsonErr(
