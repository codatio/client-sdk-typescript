 ...
 */
export async function accountingBankDataListTransactions(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingBankAccountTransactionsRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingBankTransactions$inboundSchema),
    M.jsonErr(
