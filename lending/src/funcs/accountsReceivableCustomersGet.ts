 ...
 */
export async function accountsReceivableCustomersGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingCustomerRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/data/customers/{customerId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCustomer$inboundSchema),
    M.jsonErr(
