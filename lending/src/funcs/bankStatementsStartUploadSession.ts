 ...
 */
export async function bankStatementsStartUploadSession(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StartBankStatementUploadSessionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.StartUploadSessionRequest, {
    explode: true,
  });
