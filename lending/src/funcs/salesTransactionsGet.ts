 ...
 */
export async function salesTransactionsGet(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetCommerceTransactionRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, shared.CommerceTransaction$inboundSchema),
    m$.jsonErr(
