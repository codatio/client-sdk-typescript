 ...
 */
export async function financialStatementsProfitAndLossGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingProfitAndLossRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    ...
    "periodsToCompare": payload.periodsToCompare,
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingProfitAndLossReport$inboundSchema),
    M.jsonErr(
