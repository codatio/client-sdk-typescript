 ...
 */
export async function accountsReceivablePaymentsList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingPaymentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/data/payments")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingPayments$inboundSchema),
    M.jsonErr(
