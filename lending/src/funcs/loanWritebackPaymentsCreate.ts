 ...
 */
export async function loanWritebackPaymentsCreate(
...
> {
  ...
  const body = encodeJSON("body", payload.AccountingPayment, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.AccountingCreatePaymentResponse$inboundSchema),
    M.jsonErr(
