 ...
 */
export async function bankingTransactionsList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBankingTransactionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.BankingTransactions$inboundSchema),
    M.jsonErr(
