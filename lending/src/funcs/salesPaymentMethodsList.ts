 ...
 */
export async function salesPaymentMethodsList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCommercePaymentMethodsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, shared.CommercePaymentMethods$inboundSchema),
    M.jsonErr(
