...
const args = {
  request: operations.ListCommerceTransactionsRequest$inboundSchema,
};

export const tool$salesTransactionsList: ToolDefinition<typeof args> = {
  name: "sales-transactions-list",
...
Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await salesTransactionsList(
      client,
      args.request,
