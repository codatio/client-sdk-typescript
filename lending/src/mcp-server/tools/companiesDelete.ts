...
const args = {
  request: operations.DeleteCompanyRequest$inboundSchema,
};

export const tool$companiesDelete: ToolDefinition<typeof args> = {
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await companiesDelete(
      client,
      args.request,
