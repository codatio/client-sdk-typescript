...
| ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- |
| `available`                                                      | *Decimal | number*                                               | :heavy_minus_sign:                                               | The account's current balance                                    |                                                                  |
| `pending`                                                        | *Decimal | number*                                               | :heavy_minus_sign:                                               | Funds that are not yet available in the balance                  |                                                                  |
