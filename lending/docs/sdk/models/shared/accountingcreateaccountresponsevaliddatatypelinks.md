...
```typescript
import { AccountingCreateAccountResponseValidDataTypeLinks } from "@codat/lending/sdk/models/shared";

let value: AccountingCreateAccountResponseValidDataTypeLinks = {};
```
