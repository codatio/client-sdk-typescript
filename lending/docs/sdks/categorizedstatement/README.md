...
async function run() {
  const result = await codatLending.banking.categorizedStatement.get({
...
import { bankingCategorizedStatementGet } from "@codat/lending/funcs/bankingCategorizedStatementGet.js";
...
async function run() {
  const res = await bankingCategorizedStatementGet(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
  });
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetCategorizedBankStatementRequest](../../sdk/models/operations/getcategorizedbankstatementrequest.md)                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[shared.EnhancedCashFlowTransactions](../../sdk/models/shared/enhancedcashflowtransactions.md)\>**
