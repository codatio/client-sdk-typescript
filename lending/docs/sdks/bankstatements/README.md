...
* [getCategorizedBankStatementTransactions](#getcategorizedbankstatementtransactions) - Get categorized bank statement transactions
* [listCategorizedBankStatementAccounts](#listcategorizedbankstatementaccounts) - List categorized bank statement accounts
* [downloadCategorizedBankStatementExcel](#downloadcategorizedbankstatementexcel) - Download categorized bank statement Excel
...
## getCategorizedBankStatementTransactions
...
<!-- UsageSnippet language="typescript" operationID="get-categorized-bank-statement-transactions" method="get" path="/companies/{companyId}/reports/categorizedBankStatement/{reportId}/transactions" -->
```typescript
import { CodatLending } from "@codat/lending";
...
async function run() {
  const result = await codatLending.bankStatements.getCategorizedBankStatementTransactions({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { bankStatementsGetCategorizedBankStatementTransactions } from "@codat/lending/funcs/bankStatementsGetCategorizedBankStatementTransactions.js";
...
async function run() {
  const res = await bankStatementsGetCategorizedBankStatementTransactions(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    maxAge: "2022-10-23T00:00:00Z",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
    orderBy: "-modifiedDate",
  ...
  if (res.ok) {
    ...
    console.log("bankStatementsGetCategorizedBankStatementTransactions failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | GetCategorizedBankStatementTransactionsRequest                                                                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[CategorizedBankStatementTransactions](../../models/.md)\>**
...
## listCategorizedBankStatementAccounts
...
<!-- UsageSnippet language="typescript" operationID="list-categorized-bank-statement-accounts" method="get" path="/companies/{companyId}/reports/categorizedBankStatement/{reportId}/accounts" -->
```typescript
import { CodatLending } from "@codat/lending";
...
async function run() {
  const result = await codatLending.bankStatements.listCategorizedBankStatementAccounts({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    maxAge: "2022-10-23T00:00:00Z",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
    orderBy: "-modifiedDate",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { bankStatementsListCategorizedBankStatementAccounts } from "@codat/lending/funcs/bankStatementsListCategorizedBankStatementAccounts.js";
...
async function run() {
  const res = await bankStatementsListCategorizedBankStatementAccounts(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    maxAge: "2022-10-23T00:00:00Z",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
    orderBy: "-modifiedDate",
  ...
  if (res.ok) {
    ...
    console.log("bankStatementsListCategorizedBankStatementAccounts failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | ListCategorizedBankStatementAccountsRequest                                                                                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[CategorizedBankStatementAccounts](../../models/.md)\>**
...
## downloadCategorizedBankStatementExcel
...
<!-- UsageSnippet language="typescript" operationID="download-categorized-bank-statement-excel" method="get" path="/companies/{companyId}/reports/categorizedBankStatement/{reportId}/excel" -->
```typescript
import { CodatLending } from "@codat/lending";
...
async function run() {
  const result = await codatLending.bankStatements.downloadCategorizedBankStatementExcel({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    maxAge: "2022-10-23T00:00:00Z",
  });
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { bankStatementsDownloadCategorizedBankStatementExcel } from "@codat/lending/funcs/bankStatementsDownloadCategorizedBankStatementExcel.js";
...
async function run() {
  const res = await bankStatementsDownloadCategorizedBankStatementExcel(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    maxAge: "2022-10-23T00:00:00Z",
  });
  if (res.ok) {
    ...
    console.log("bankStatementsDownloadCategorizedBankStatementExcel failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | DownloadCategorizedBankStatementExcelRequest                                                                                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
