...
async function run() {
  const result = await codatLending.loanWriteback.accounts.getCreateModel({
...
import { loanWritebackAccountsGetCreateModel } from "@codat/lending/funcs/loanWritebackAccountsGetCreateModel.js";
...
async function run() {
  const res = await loanWritebackAccountsGetCreateModel(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  });
...
async function run() {
  const result = await codatLending.loanWriteback.accounts.create({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    accountPrototype: {
      nominalCode: "610",
...
async function run() {
  const res = await loanWritebackAccountsCreate(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    accountPrototype: {
      nominalCode: "610",
...
**Promise\<[shared.AccountingCreateAccountResponse](../../sdk/models/shared/accountingcreateaccountresponse.md)\>**
