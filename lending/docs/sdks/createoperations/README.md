...
import { loanWritebackCreateOperationsGet } from "@codat/lending/funcs/loanWritebackCreateOperationsGet.js";
...
async function run() {
  const result = await codatLending.loanWriteback.createOperations.list({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { loanWritebackCreateOperationsList } from "@codat/lending/funcs/loanWritebackCreateOperationsList.js";
...
async function run() {
  const res = await loanWritebackCreateOperationsList(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
    orderBy: "-modifiedDate",
  });
