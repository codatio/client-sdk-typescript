...
async function run() {
  const result = await codatLending.sales.productCategories.list({
...
import { salesProductCategoriesList } from "@codat/lending/funcs/salesProductCategoriesList.js";
...
async function run() {
  const res = await salesProductCategoriesList(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
    orderBy: "-modifiedDate",
  ...
  if (res.ok) {
    ...
    console.log("salesProductCategoriesList failed:", res.error);
  }
}
...
**Promise\<[shared.CommerceProductCategories](../../sdk/models/shared/commerceproductcategories.md)\>**
...
async function run() {
  const result = await codatLending.sales.productCategories.get({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { salesProductCategoriesGet } from "@codat/lending/funcs/salesProductCategoriesGet.js";
...
async function run() {
  const res = await salesProductCategoriesGet(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    productId: "13d946f0-c5d5-42bc-b092-97ece17923ab",
  });
  if (res.ok) {
    ...
    console.log("salesProductCategoriesGet failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetCommerceProductCategoryRequest](../../sdk/models/operations/getcommerceproductcategoryrequest.md)                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[shared.CommerceProductCategory](../../sdk/models/shared/commerceproductcategory.md)\>**
