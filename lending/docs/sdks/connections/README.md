...
async function run() {
  const result = await codatLending.connections.list({
...
import { connectionsList } from "@codat/lending/funcs/connectionsList.js";
...
async function run() {
  const res = await connectionsList(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
    orderBy: "-modifiedDate",
  });
...
async function run() {
  const result = await codatLending.connections.create({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    requestBody: {
      platformKey: "gbol",
    },
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { connectionsCreate } from "@codat/lending/funcs/connectionsCreate.js";
...
async function run() {
  const res = await connectionsCreate(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    requestBody: {
      platformKey: "gbol",
    },
...
async function run() {
  const result = await codatLending.connections.get({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { connectionsGet } from "@codat/lending/funcs/connectionsGet.js";
...
async function run() {
  const res = await connectionsGet(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  });
...
async function run() {
  await codatLending.connections.delete({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  });
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { connectionsDelete } from "@codat/lending/funcs/connectionsDelete.js";
...
async function run() {
  const res = await connectionsDelete(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  });
...
async function run() {
  const result = await codatLending.connections.unlink({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    requestBody: {
      status: "Unlinked",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { connectionsUnlink } from "@codat/lending/funcs/connectionsUnlink.js";
...
async function run() {
  const res = await connectionsUnlink(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    requestBody: {
      status: "Unlinked",
