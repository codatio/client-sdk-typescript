...
sdk.transactions.downloadDirectCostAttachment({
...
sdk.transactions.getDirectCostAttachment({
  attachmentId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  directCostId: "error",
...
```typescript
import { CodatLending } from "@codat/lending";
import { GetAccountingTransferResponse } from "@codat/lending/dist/sdk/models/operations";
...
sdk.transactions.listAccountTransactions({
  companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
sdk.transactions.listDirectCosts({
  companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  orderBy: "-modifiedDate",
  page: 1,
...
sdk.transactions.listJournalEntries({
  companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  orderBy: "-modifiedDate",
  page: 1,
  pageSize: 100,
...
```typescript
import { CodatLending } from "@codat/lending";
import { ListAccountingTransfersResponse } from "@codat/lending/dist/sdk/models/operations";
...
sdk.transactions.listTransfers({
  companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  orderBy: "-modifiedDate",
  page: 1,
