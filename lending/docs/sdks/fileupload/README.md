...
async function run() {
  const result = await codatLending.fileUpload.listUploaded({
...
import { fileUploadListUploaded } from "@codat/lending/funcs/fileUploadListUploaded.js";
...
**Promise\<[shared.FileT[]](../../models/.md)\>**
...
async function run() {
  const result = await codatLending.fileUpload.download({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { fileUploadDownload } from "@codat/lending/funcs/fileUploadDownload.js";
...
async function run() {
  const res = await fileUploadDownload(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    date: "2022-10-23T00:00:00Z",
  });
...
```typescript
import { CodatLendingCore } from "@codat/lending/core.js";
import { fileUploadUpload } from "@codat/lending/funcs/fileUploadUpload.js";
...
async function run() {
  const res = await fileUploadUpload(codatLending, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  });
