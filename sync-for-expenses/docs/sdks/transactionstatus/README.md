...
import { transactionStatusList } from "@codat/sync-for-expenses/funcs/transactionStatusList.js";
...
```typescript
import { CodatSyncExpensesCore } from "@codat/sync-for-expenses/core.js";
import { transactionStatusGet } from "@codat/sync-for-expenses/funcs/transactionStatusGet.js";
...
async function run() {
  const res = await transactionStatusGet(codatSyncExpenses, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    syncId: "6fb40d5e-b13e-11ed-afa1-0242ac120002",
    transactionId: "336694d8-2dca-4cb5-a28d-3ccb83e55eee",
  });
