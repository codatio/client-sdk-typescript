...
type Call = CodatSyncExpenses["reimbursements"]["create"];

export function reimbursementsCreate(
    ...
    return new APIPromise(toResult(() => client.reimbursements.create(request, options)));
}
