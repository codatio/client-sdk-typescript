...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateExpenseTransactionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateExpenseRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, shared.UpdateExpenseResponse$inboundSchema),
    M.jsonErr(
