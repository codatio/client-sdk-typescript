...
import type { CodatSyncExpensesCore } from "../core";
...
type ValidateWebhookResult = shared.ExpensesSyncWebhook | shared.ClientRateLimitWebhook | undefined;
...
const WEBHOOK_MATCH_ORDER: { name: string; spec: WebhookMatchSpec }[] = [
    { name: "ExpensesSyncWebhook", spec: {"kind": "object", "required": [], "props": {"id": "string", "eventType": "string", "generatedDate": "string", "payload": {"kind": "object", "required": [], "props": {"referenceCompany": {"kind": "object", "required": [], "props": {"id": "string", "name": "string", "description": "string", "links": {"kind": "object", "required": [], "props": {"portal": "string"}}, "tags": {"kind": "object", "required": [], "props": {}}}}, "syncId": "string", "transactions": {"kind": "array", "items": {"kind": "object", "required": [], "props": {"id": "string", "status": "string", "errorMessage": {"kind": "nullable", "inner": "string"}}}}}}}} },
...
export function validateWebhook(_client: CodatSyncExpensesCore, { request }: { request: { body: string; method: string; url: string; headers: Record<string, string> | Headers } | Request }): APIPromise<Result<ValidateWebhookResult, SDKValidationError>> {
    void _client;
