...
type Call = CodatSyncExpenses["sync"]["getLastSuccessfulSync"];

export function syncGetLastSuccessfulSync(
    ...
    return new APIPromise(toResult(() => client.sync.getLastSuccessfulSync(request, options)));
}
