...
type Call = CodatSyncExpenses["manageData"]["refreshAllDataTypes"];

export function manageDataRefreshAllDataTypes(
    ...
    return new APIPromise(toResult(() => client.manageData.refreshAllDataTypes(request, options)));
}
