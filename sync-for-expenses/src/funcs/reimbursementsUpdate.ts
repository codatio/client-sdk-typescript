...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateReimbursableExpenseTransactionRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.UpdateReimbursableExpenseTransactionRequest,
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.CreateReimbursableExpenseResponse$inboundSchema),
    M.jsonErr(
