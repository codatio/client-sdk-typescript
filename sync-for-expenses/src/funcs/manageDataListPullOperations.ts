...
type Call = CodatSyncExpenses["manageData"]["listPullOperations"];

export function manageDataListPullOperations(
    ...
    return new APIPromise(toResult(() => client.manageData.listPullOperations(request, options)));
}
