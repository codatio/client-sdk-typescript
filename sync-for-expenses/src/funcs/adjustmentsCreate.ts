...
type Call = CodatSyncExpenses["adjustments"]["create"];

export function adjustmentsCreate(
    ...
    return new APIPromise(toResult(() => client.adjustments.create(request, options)));
}
