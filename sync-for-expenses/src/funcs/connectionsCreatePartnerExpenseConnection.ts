...
type Call = CodatSyncExpenses["connections"]["createPartnerExpenseConnection"];

export function connectionsCreatePartnerExpenseConnection(
    ...
    return new APIPromise(toResult(() => client.connections.createPartnerExpenseConnection(request, options)));
}
