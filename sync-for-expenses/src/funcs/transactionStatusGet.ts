...
type Call = CodatSyncExpenses["transactionStatus"]["get"];

export function transactionStatusGet(
    ...
    return new APIPromise(toResult(() => client.transactionStatus.get(request, options)));
}
