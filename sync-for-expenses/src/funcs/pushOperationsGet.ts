...
type Call = CodatSyncExpenses["pushOperations"]["get"];

export function pushOperationsGet(
    ...
    return new APIPromise(toResult(() => client.pushOperations.get(request, options)));
}
