...
type Call = CodatSyncExpenses["manageData"]["getPullOperation"];

export function manageDataGetPullOperation(
    ...
    return new APIPromise(toResult(() => client.manageData.getPullOperation(request, options)));
}
