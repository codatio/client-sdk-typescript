...
type Call = CodatSyncExpenses["pushOperations"]["list"];

export function pushOperationsList(
    ...
    return new APIPromise(toResult(() => client.pushOperations.list(request, options)));
}
