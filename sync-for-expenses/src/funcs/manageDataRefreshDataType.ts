...
type Call = CodatSyncExpenses["manageData"]["refreshDataType"];

export function manageDataRefreshDataType(
    ...
    return new APIPromise(toResult(() => client.manageData.refreshDataType(request, options)));
}
