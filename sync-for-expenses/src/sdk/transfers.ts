...
export class Transfers extends ClientSDK {
    ...
    async create(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.CreateTransferTransactionRequest$outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = encodeJSON$("body", payload$.TransferTransactionRequest, { explode: true });
        ...
        const [result$] = await this.matcher<shared.TransferTransactionResponse>()
            .json(200, shared.TransferTransactionResponse$inboundSchema)
