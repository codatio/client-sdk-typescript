...
export class UpdateReimbursableExpenseTransactionRequest extends SpeakeasyBase {
...
export class UpdateReimbursableExpenseTransactionResponse extends SpeakeasyBase {
    /**
