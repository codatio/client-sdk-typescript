...
/** @internal */
export const MappingOptions$inboundSchema: z.ZodType<MappingOptions, z.ZodTypeDef, unknown> =
    z.object({
        ...
        trackingCategories: z
            .nullable(z.array(TrackingCategoryMappingInfo$inboundSchema))
            .optional(),
...
export type MappingOptions$Outbound = {
    ...
    trackingCategories?: Array<TrackingCategoryMappingInfo$Outbound> | null | undefined;
...
> = z.object({
    ...
    trackingCategories: z.nullable(z.array(TrackingCategoryMappingInfo$outboundSchema)).optional(),
