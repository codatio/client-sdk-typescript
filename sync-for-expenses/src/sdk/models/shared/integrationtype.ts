...
/** @internal */
export const IntegrationType$inboundSchema: z.ZodNativeEnum<typeof IntegrationType> =
    z.nativeEnum(IntegrationType);

/** @internal */
export const IntegrationType$outboundSchema: z.ZodNativeEnum<typeof IntegrationType> =
