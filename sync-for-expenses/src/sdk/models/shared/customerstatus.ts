...
/** @internal */
export const CustomerStatus$inboundSchema: z.ZodNativeEnum<typeof CustomerStatus> =
    z.nativeEnum(CustomerStatus);

/** @internal */
export const CustomerStatus$outboundSchema: z.ZodNativeEnum<typeof CustomerStatus> =
