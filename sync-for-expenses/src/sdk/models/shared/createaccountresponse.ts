...
export namespace CreateAccountResponseValidDataTypeLinks$ {
  ...
  export const inboundSchema =
    CreateAccountResponseValidDataTypeLinks$inboundSchema;
  /** @deprecated use `CreateAccountResponseValidDataTypeLinks$outboundSchema` instead. */
  export const outboundSchema =
    CreateAccountResponseValidDataTypeLinks$outboundSchema;
...
export function createAccountResponseValidDataTypeLinksToJSON(
  createAccountResponseValidDataTypeLinks:
    CreateAccountResponseValidDataTypeLinks,
): string {
  return JSON.stringify(
    CreateAccountResponseValidDataTypeLinks$outboundSchema.parse(
      createAccountResponseValidDataTypeLinks,
    ),
  );
}
...
export function createAccountResponseMetadataToJSON(
  createAccountResponseMetadata: CreateAccountResponseMetadata,
): string {
  return JSON.stringify(
    CreateAccountResponseMetadata$outboundSchema.parse(
      createAccountResponseMetadata,
    ),
  );
}

export function createAccountResponseMetadataFromJSON(
  jsonString: string,
): SafeParseResult<CreateAccountResponseMetadata, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateAccountResponseMetadata$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateAccountResponseMetadata' from JSON`,
  );
}
...
> = z.object({
  ...
  metadata: z.lazy(() => CreateAccountResponseMetadata$inboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  validDatatypeLinks: z.nullable(
    z.array(
      z.lazy(() => CreateAccountResponseValidDataTypeLinks$outboundSchema),
    ),
  ).optional(),
  supplementalData: SupplementalData$outboundSchema.optional(),
  metadata: z.lazy(() => CreateAccountResponseMetadata$outboundSchema)
    .optional(),
});
