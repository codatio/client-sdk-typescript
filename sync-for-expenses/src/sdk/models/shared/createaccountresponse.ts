...
export class CreateAccountResponseMetadata extends SpeakeasyBase {
    /**
 ...
 */
export class CreateAccountResponseValidDataTypeLinks extends SpeakeasyBase {
    /**
...
export class AccountingAccount extends SpeakeasyBase {
    ...
    @Type(() => CreateAccountResponseMetadata)
     ...
     */
    @SpeakeasyMetadata({ elemType: CreateAccountResponseValidDataTypeLinks })
    @Expose({ name: "validDatatypeLinks" })
    @Type(() => CreateAccountResponseValidDataTypeLinks)
    validDatatypeLinks?: CreateAccountResponseValidDataTypeLinks[];
}
