...
export function TransactionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Transactions {
    ...
    return {
        ...
        ...(json['results'] !== undefined ? { 'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(TransactionFromJSON)) } : {}),
    };
}
...
export interface ListSyncTransactionsResponseTransactions {
    [key: string]: any | any;
    /**
     * Current page number.
     * @type {number}
...
export interface SyncTransactionsListResponseTransactions {
    [key: string]: any | any;
    /**
     * Current page number.
     * @type {number}
