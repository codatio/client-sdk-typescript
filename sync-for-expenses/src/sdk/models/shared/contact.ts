...
export function ContactFromJSONTyped(json: any, ignoreDiscriminator: boolean): Contact {
    ...
    return {
        ...
        'phone': json['phone'] == null ? undefined : ((json['phone'] as Array<any>).map(PhoneNumberItemsFromJSON)),
        'address': json['address'] == null ? undefined : ItemsFromJSON(json['address']),
...
export function ContactToJSONTyped(value?: Contact | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'name': value['name'],
        'email': value['email'],
        'phone': value['phone'] == null ? undefined : ((value['phone'] as Array<any>).map(PhoneNumberItemsToJSON)),
