...
import {
  ApAccountRef,
  ApAccountRef$inboundSchema,
  ApAccountRef$Outbound,
  ApAccountRef$outboundSchema,
} from "./apaccountref.js";
import {
...
export type ReimbursableExpenseTransaction = {
  ...
  apAccountRef?: ApAccountRef | null | undefined;
  /**
...
> = z.object({
  ...
  apAccountRef: z.nullable(ApAccountRef$inboundSchema).optional(),
  issueDate: z.string(),
  dueDate: z.string(),
  currency: z.string(),
...
export type ReimbursableExpenseTransaction$Outbound = {
  ...
  apAccountRef?: ApAccountRef$Outbound | null | undefined;
  issueDate: string;
  dueDate: string;
  currency: string;
...
> = z.object({
  ...
  apAccountRef: z.nullable(ApAccountRef$outboundSchema).optional(),
  issueDate: z.string(),
  dueDate: z.string(),
  currency: z.string(),
...
export function reimbursableExpenseTransactionToJSON(
  reimbursableExpenseTransaction: ReimbursableExpenseTransaction,
): string {
  return JSON.stringify(
    ReimbursableExpenseTransaction$outboundSchema.parse(
      reimbursableExpenseTransaction,
    ),
  );
}

export function reimbursableExpenseTransactionFromJSON(
  jsonString: string,
): SafeParseResult<ReimbursableExpenseTransaction, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ReimbursableExpenseTransaction$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ReimbursableExpenseTransaction' from JSON`,
  );
}
