...
/** @internal */
export const SupplierStatus$inboundSchema: z.ZodNativeEnum<typeof SupplierStatus> =
    z.nativeEnum(SupplierStatus);

/** @internal */
export const SupplierStatus$outboundSchema: z.ZodNativeEnum<typeof SupplierStatus> =
