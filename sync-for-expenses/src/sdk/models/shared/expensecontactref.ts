...
/** @internal */
export const ExpenseContactRefType$inboundSchema: z.ZodNativeEnum<
...
/** @internal */
export const ExpenseContactRef$inboundSchema: z.ZodType<
  ExpenseContactRef,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function expenseContactRefFromJSON(
  jsonString: string,
): SafeParseResult<ExpenseContactRef, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExpenseContactRef$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExpenseContactRef' from JSON`,
  );
}
