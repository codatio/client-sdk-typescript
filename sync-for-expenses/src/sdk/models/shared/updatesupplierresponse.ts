...
export namespace UpdateSupplierResponseAccountingSupplier$ {
    ...
    export const inboundSchema = UpdateSupplierResponseAccountingSupplier$inboundSchema;
    /** @deprecated use `UpdateSupplierResponseAccountingSupplier$outboundSchema` instead. */
    export const outboundSchema = UpdateSupplierResponseAccountingSupplier$outboundSchema;
