 ...
 * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
 */
export type CreateBankAccountResponseBankAccountType = ClosedEnum<
  typeof CreateBankAccountResponseBankAccountType
>;
...
/** @internal */
export const CreateBankAccountResponseBankAccountType$inboundSchema:
  z.ZodNativeEnum<typeof CreateBankAccountResponseBankAccountType> = z
    .nativeEnum(CreateBankAccountResponseBankAccountType);

/** @internal */
export const CreateBankAccountResponseBankAccountType$outboundSchema:
  z.ZodNativeEnum<typeof CreateBankAccountResponseBankAccountType> =
    CreateBankAccountResponseBankAccountType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreateBankAccountResponseBankAccountType$ {
  /** @deprecated use `CreateBankAccountResponseBankAccountType$inboundSchema` instead. */
  export const inboundSchema =
    CreateBankAccountResponseBankAccountType$inboundSchema;
  /** @deprecated use `CreateBankAccountResponseBankAccountType$outboundSchema` instead. */
  export const outboundSchema =
    CreateBankAccountResponseBankAccountType$outboundSchema;
}
...
> = z.object({
  ...
  accountType: CreateBankAccountResponseBankAccountType$inboundSchema
    .optional(),
...
> = z.object({
  ...
  id: z.string().optional(),
  accountName: z.nullable(z.string()).optional(),
  accountType: CreateBankAccountResponseBankAccountType$outboundSchema
    .optional(),
  nominalCode: z.nullable(z.string()).optional(),
  sortCode: z.nullable(z.string()).optional(),
  accountNumber: z.nullable(z.string()).optional(),
