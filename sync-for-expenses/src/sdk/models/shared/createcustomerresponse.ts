...
export class CreateCustomerResponseAccountingAddress extends SpeakeasyBase {
    /**
...
export class AccountingCustomer extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata({ elemType: CreateCustomerResponseAccountingAddress })
    @Expose({ name: "addresses" })
    @Type(() => CreateCustomerResponseAccountingAddress)
    addresses?: CreateCustomerResponseAccountingAddress[];
