...
export type CreateCustomerResponseAccountingAddress = {
    /**
...
export type AccountingCustomer = {
     ...
     */
    addresses?: Array<CreateCustomerResponseAccountingAddress> | null | undefined;
    /**
...
/** @internal */
export const CreateCustomerResponseAccountingAddress$inboundSchema: z.ZodType<
    CreateCustomerResponseAccountingAddress,
    z.ZodTypeDef,
    unknown
> = z.object({
...
/** @internal */
export type CreateCustomerResponseAccountingAddress$Outbound = {
    type: string;
    line1?: string | null | undefined;
    line2?: string | null | undefined;
    city?: string | null | undefined;
...
/** @internal */
export const CreateCustomerResponseAccountingAddress$outboundSchema: z.ZodType<
    CreateCustomerResponseAccountingAddress$Outbound,
    z.ZodTypeDef,
    CreateCustomerResponseAccountingAddress
> = z.object({
 ...
 */
export namespace CreateCustomerResponseAccountingAddress$ {
    /** @deprecated use `CreateCustomerResponseAccountingAddress$inboundSchema` instead. */
    export const inboundSchema = CreateCustomerResponseAccountingAddress$inboundSchema;
    /** @deprecated use `CreateCustomerResponseAccountingAddress$outboundSchema` instead. */
    export const outboundSchema = CreateCustomerResponseAccountingAddress$outboundSchema;
    /** @deprecated use `CreateCustomerResponseAccountingAddress$Outbound` instead. */
    export type Outbound = CreateCustomerResponseAccountingAddress$Outbound;
}
...
> = z.object({
    ...
    addresses: z
        .nullable(z.array(z.lazy(() => CreateCustomerResponseAccountingAddress$inboundSchema)))
        .optional(),
...
export type AccountingCustomer$Outbound = {
    ...
    defaultCurrency?: string | undefined;
    phone?: string | null | undefined;
    addresses?: Array<CreateCustomerResponseAccountingAddress$Outbound> | null | undefined;
...
> = z.object({
    ...
    phone: z.nullable(z.string()).optional(),
    addresses: z
        .nullable(z.array(z.lazy(() => CreateCustomerResponseAccountingAddress$outboundSchema)))
        .optional(),
