...
**Promise\<[models.AddCompanyToGroupResponse](../../models/addcompanytogroupresponse.md)\>**
### Errors
...
**Promise\<[models.CreateGroupResponse](../../models/creategroupresponse.md)\>**
### Errors
...
**Promise\<[models.ListGroupsResponse](../../models/listgroupsresponse.md)\>**
### Errors
...
async function run() {
  const result = await codatPlatform.groups.removeCompany({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    groupId: "60d2fa12-8a04-11ee-b9d1-0242ac120002",
  });
...
**Promise\<[models.RemoveCompanyFromGroupResponse](../../models/removecompanyfromgroupresponse.md)\>**
### Errors
