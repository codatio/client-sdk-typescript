...
async function run() {
  const result = await codatPlatform.pushData.getModelOptions({
...
import { pushDataGetModelOptions } from "@codat/platform/funcs/pushDataGetModelOptions.js";
...
async function run() {
  const res = await pushDataGetModelOptions(codatPlatform, {
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    dataType: "invoices",
  });
...
```typescript
import { CodatPlatformCore } from "@codat/platform/core.js";
import { pushDataListOperations } from "@codat/platform/funcs/pushDataListOperations.js";
...
```typescript
import { CodatPlatformCore } from "@codat/platform/core.js";
import { pushDataGetOperation } from "@codat/platform/funcs/pushDataGetOperation.js";
