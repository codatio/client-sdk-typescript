...
**Promise\<[models.WebhookConsumers](../../models/webhookconsumers.md)\>**
### Errors
...
**Promise\<[models.WebhookConsumer](../../models/webhookconsumer.md)\>**
### Errors
...
async function run() {
  await codatPlatform.webhooks.deleteConsumer({
