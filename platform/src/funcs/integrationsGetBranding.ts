...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIntegrationsBrandingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/integrations/{platformKey}/branding")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.Branding$inboundSchema),
