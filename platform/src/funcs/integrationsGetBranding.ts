...
type Call = CodatPlatform["integrations"]["getBranding"];

export function integrationsGetBranding(
    ...
    return new APIPromise(toResult(() => client.integrations.getBranding(request, options)));
}
