...
type Call = CodatPlatform["refreshData"]["listPullOperations"];

export function refreshDataListPullOperations(
    ...
    return new APIPromise(toResult(() => client.refreshData.listPullOperations(request, options)));
}
