...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCompanyDataStatusRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/dataStatus")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.DataStatuses$inboundSchema),
