...
type Call = CodatPlatform["companies"]["removeProduct"];

export function companiesRemoveProduct(
    ...
    return new APIPromise(toResult(() => client.companies.removeProduct(request, options)));
}
