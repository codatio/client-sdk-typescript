...
type Call = CodatPlatform["customDataType"]["list"];

export function customDataTypeList(
    ...
    return new APIPromise(toResult(() => client.customDataType.list(request, options)));
}
