...
type Call = CodatPlatform["pushData"]["getOperation"];

export function pushDataGetOperation(
    ...
    return new APIPromise(toResult(() => client.pushData.getOperation(request, options)));
}
