...
type Call = CodatPlatform["refreshData"]["getPullOperation"];

export function refreshDataGetPullOperation(
    ...
    return new APIPromise(toResult(() => client.refreshData.getPullOperation(request, options)));
}
