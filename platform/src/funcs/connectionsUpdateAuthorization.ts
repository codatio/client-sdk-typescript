...
type Call = CodatPlatform["connections"]["updateAuthorization"];

export function connectionsUpdateAuthorization(
    ...
    return new APIPromise(toResult(() => client.connections.updateAuthorization(request, options)));
}
