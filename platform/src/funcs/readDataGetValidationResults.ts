...
type Call = CodatPlatform["readData"]["getValidationResults"];

export function readDataGetValidationResults(
    ...
    return new APIPromise(toResult(() => client.readData.getValidationResults(request, options)));
}
