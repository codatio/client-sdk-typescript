...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetReadValidationResultsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/sync/{datasetId}/validation")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.ValidationResult$inboundSchema),
