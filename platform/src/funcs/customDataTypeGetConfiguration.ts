...
type Call = CodatPlatform["customDataType"]["getConfiguration"];

export function customDataTypeGetConfiguration(
    ...
    return new APIPromise(toResult(() => client.customDataType.getConfiguration(request, options)));
}
