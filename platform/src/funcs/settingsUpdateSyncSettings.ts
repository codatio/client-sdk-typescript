...
type Call = CodatPlatform["settings"]["updateSyncSettings"];

export function settingsUpdateSyncSettings(
    ...
    return new APIPromise(toResult(() => client.settings.updateSyncSettings(request, options)));
}
