...
type Call = CodatPlatform["supplementalData"]["getConfiguration"];

export function supplementalDataGetConfiguration(
    ...
    return new APIPromise(toResult(() => client.supplementalData.getConfiguration(request, options)));
}
