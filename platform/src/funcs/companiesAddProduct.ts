...
type Call = CodatPlatform["companies"]["addProduct"];

export function companiesAddProduct(
    ...
    return new APIPromise(toResult(() => client.companies.addProduct(request, options)));
}
