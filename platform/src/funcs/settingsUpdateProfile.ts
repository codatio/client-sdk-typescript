...
type Call = CodatPlatform["settings"]["updateProfile"];

export function settingsUpdateProfile(
    ...
    return new APIPromise(toResult(() => client.settings.updateProfile(request, options)));
}
