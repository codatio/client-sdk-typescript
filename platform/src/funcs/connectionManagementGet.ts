...
type Call = CodatPlatform["connectionManagement"]["get"];

export function connectionManagementGet(
    ...
    return new APIPromise(toResult(() => client.connectionManagement.get(request, options)));
}
