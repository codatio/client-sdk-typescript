...
type Call = CodatPlatform["supplementalData"]["configure"];

export function supplementalDataConfigure(
    ...
    return new APIPromise(toResult(() => client.supplementalData.configure(request, options)));
}
