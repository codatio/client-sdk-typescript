...
type Call = CodatPlatform["companies"]["setCompanySyncSettings"];

export function companiesSetCompanySyncSettings(
    ...
    return new APIPromise(toResult(() => client.companies.setCompanySyncSettings(request, options)));
}
