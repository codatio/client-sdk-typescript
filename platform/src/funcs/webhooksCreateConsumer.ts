...
type Call = CodatPlatform["webhooks"]["createConsumer"];

export function webhooksCreateConsumer(
    ...
    return new APIPromise(toResult(() => client.webhooks.createConsumer(request, options)));
}
