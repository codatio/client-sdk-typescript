...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCompanySyncSettingsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/companies/{companyId}/syncSettings")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.CompanySyncSettings$inboundSchema),
