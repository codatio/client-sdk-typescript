...
type Call = CodatPlatform["companies"]["getCompanySyncSettings"];

export function companiesGetCompanySyncSettings(
    ...
    return new APIPromise(toResult(() => client.companies.getCompanySyncSettings(request, options)));
}
