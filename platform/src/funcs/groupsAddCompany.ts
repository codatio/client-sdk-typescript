 ...
 */
export async function groupsAddCompany(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.AddCompanyToGroupRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.companyGroupAssignment, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/companies/{companyId}/groups")(pathParams$);
