...
export class CustomDataType extends ClientSDK {
    ...
    async configure(
    ...
    ): Promise<models.CustomDataTypeConfiguration> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<models.CustomDataTypeConfiguration>()
            .json(200, models.CustomDataTypeConfiguration$)
    ...
    async getConfiguration(
        ...
        options?: RequestOptions & { retries?: retries$.RetryConfig }
    ): Promise<models.CustomDataTypeRecords> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
        headers$.set("Accept", "application/json");
        ...
        const [result$] = await this.matcher<models.CustomDataTypeRecords>()
            .json(200, models.CustomDataTypeRecords$)
            .json([401, 402, 403, 404, 429, 500, 503], models.ErrorMessage$, { err: true })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async refresh(
        ...
        const [result$] = await this.matcher<models.PullOperation>()
            ...
            .json([401, 402, 403, 404, 429, 451, 500, 503], models.ErrorMessage$, { err: true })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async list(
        ...
        const [result$] = await this.matcher<models.CustomDataTypeRecords>()
            .json(200, models.CustomDataTypeRecords$)
            .json([400, 401, 402, 403, 404, 429, 451, 500, 503], models.ErrorMessage$, {
                err: true,
            })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
