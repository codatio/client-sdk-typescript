...
export namespace SupplementalDataSourceConfiguration$ {
    ...
    export const inboundSchema = SupplementalDataSourceConfiguration$inboundSchema;
    /** @deprecated use `SupplementalDataSourceConfiguration$outboundSchema` instead. */
    export const outboundSchema = SupplementalDataSourceConfiguration$outboundSchema;
