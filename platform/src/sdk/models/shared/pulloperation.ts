...
/** @internal */
export const DatasetStatus$outboundSchema: z.ZodNativeEnum<typeof DatasetStatus> =
...
/** @internal */
export const PullOperation$inboundSchema: z.ZodType<PullOperation, z.ZodTypeDef, unknown> =
    z.object({
        id: z.string(),
        companyId: z.string(),
