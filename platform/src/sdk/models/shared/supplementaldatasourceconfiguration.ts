...
export function SupplementalDataSourceConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupplementalDataSourceConfiguration {
    ...
    return {
        ...
        ...(json['pullData'] !== undefined ? { 'pullData': json['pullData'] == null ? undefined : json['pullData'] } : {}),
        ...(json['pushData'] !== undefined ? { 'pushData': json['pushData'] == null ? undefined : json['pushData'] } : {}),
    };
}
