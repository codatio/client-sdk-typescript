...
export function BrandingLogoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrandingLogo {
    ...
    return {
        ...
        ...(json['full'] !== undefined ? { 'full': json['full'] == null ? undefined : BrandingImageFromJSON(json['full']) } : {}),
        ...(json['square'] !== undefined ? { 'square': json['square'] == null ? undefined : BrandingImageFromJSON(json['square']) } : {}),
    };
}
