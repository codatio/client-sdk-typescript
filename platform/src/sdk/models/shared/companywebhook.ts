...
/**
 * Check if a given object implements the CompanyWebhook interface.
 */
export function instanceOfCompanyWebhook(value: object): value is CompanyWebhook {
    return true;
}

export function CompanyWebhookFromJSON(json: any): CompanyWebhook {
    return CompanyWebhookFromJSONTyped(json, false);
}

export function CompanyWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyWebhook {
    if (json == null) {
        return json;
    }
    return {
        ...
        ...(json['payload'] !== undefined ? { 'payload': json['payload'] == null ? undefined : CompanyDetailsFromJSON(json['payload']) } : {}),
    };
}

export function CompanyWebhookToJSON(json: any): CompanyWebhook {
    return CompanyWebhookToJSONTyped(json, false);
}

export function CompanyWebhookToJSONTyped(value?: CompanyWebhook | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'payload': CompanyDetailsToJSON(value['payload']),
    };
}
