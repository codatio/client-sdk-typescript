...
export function ValidationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Validation {
    ...
    return {
        ...
        ...(json['errors'] !== undefined ? { 'errors': json['errors'] == null ? json['errors'] : ((json['errors'] as Array<any>).map(ValidationItem1FromJSON)) } : {}),
        ...(json['warnings'] !== undefined ? { 'warnings': json['warnings'] == null ? json['warnings'] : ((json['warnings'] as Array<any>).map(ValidationItem1FromJSON)) } : {}),
    };
}
...
export function ValidationToJSONTyped(value?: Validation | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'errors': value['errors'] == null ? value['errors'] : ((value['errors'] as Array<any>).map(ValidationItem1ToJSON)),
        'warnings': value['warnings'] == null ? value['warnings'] : ((value['warnings'] as Array<any>).map(ValidationItem1ToJSON)),
    };
}
