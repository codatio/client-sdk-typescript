...
import type { ConnectionWebhookPayload } from './connectionwebhookpayload';
import {
    ConnectionWebhookPayloadFromJSON,
    ConnectionWebhookPayloadFromJSONTyped,
    ConnectionWebhookPayloadToJSON,
    ConnectionWebhookPayloadToJSONTyped,
} from './connectionwebhookpayload';
...
/**
 * Check if a given object implements the ConnectionWebhook interface.
 */
export function instanceOfConnectionWebhook(value: object): value is ConnectionWebhook {
    return true;
}
...
export function ConnectionWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionWebhook {
    if (json == null) {
        return json;
    }
    return {
        ...
        ...(json['payload'] !== undefined ? { 'payload': json['payload'] == null ? undefined : ConnectionWebhookPayloadFromJSON(json['payload']) } : {}),
    };
}

export function ConnectionWebhookToJSON(json: any): ConnectionWebhook {
    return ConnectionWebhookToJSONTyped(json, false);
}

export function ConnectionWebhookToJSONTyped(value?: ConnectionWebhook | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'payload': ConnectionWebhookPayloadToJSON(value['payload']),
    };
}
