...
/** @internal */
export const Profile$inboundSchema: z.ZodType<Profile, z.ZodTypeDef, unknown> = z.object({
    name: z.string(),
...
/** @internal */
export const Profile$outboundSchema: z.ZodType<Profile$Outbound, z.ZodTypeDef, Profile> = z.object({
    name: z.string(),
    logoUrl: z.string().optional(),
    iconUrl: z.string().optional(),
    redirectUrl: z.string(),
