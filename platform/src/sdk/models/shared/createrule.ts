...
/** @internal */
export const CreateRule$inboundSchema: z.ZodType<CreateRule, z.ZodTypeDef, unknown> = z.object({
    type: z.string(),
...
/** @internal */
export const CreateRule$outboundSchema: z.ZodType<CreateRule$Outbound, z.ZodTypeDef, CreateRule> =
    z.object({
        type: z.string(),
        companyId: z.string().optional(),
