...
export namespace DatasetStatusChangedErrorWebhookData$ {
    ...
    export const inboundSchema = DatasetStatusChangedErrorWebhookData$inboundSchema;
    /** @deprecated use `DatasetStatusChangedErrorWebhookData$outboundSchema` instead. */
    export const outboundSchema = DatasetStatusChangedErrorWebhookData$outboundSchema;
