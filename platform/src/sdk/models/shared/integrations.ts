...
/**
 * Check if a given object implements the Integrations interface.
 */
export function instanceOfIntegrations(value: object): value is Integrations {
...
export function IntegrationsFromJSON(json: any): Integrations {
    return IntegrationsFromJSONTyped(json, false);
}

export function IntegrationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Integrations {
    if (json == null) {
        return json;
    }
    return {
        ...
        ...(json['results'] !== undefined ? { 'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(IntegrationFromJSON)) } : {}),
    };
}

export function IntegrationsToJSON(json: any): Integrations {
    return IntegrationsToJSONTyped(json, false);
}

export function IntegrationsToJSONTyped(value?: Integrations | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(IntegrationToJSON)),
    };
}


export interface IntegrationsListResponseIntegrations {
    /**
     * Current page number.
     * @type {number}
     * @memberof Integrations
...
export interface ListIntegrationsResponseIntegrations {
    /**
     * Current page number.
     * @type {number}
     * @memberof Integrations
