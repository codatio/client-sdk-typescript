...
export function instanceOfWriteStatus(value: any): boolean {
    for (const key in WriteStatus) {
        if (Object.prototype.hasOwnProperty.call(WriteStatus, key)) {
            if (WriteStatus[key as keyof typeof WriteStatus] === value) {
                return true;
            }
        }
    }
...
export function WriteStatusFromJSON(json: any): WriteStatus {
    return WriteStatusFromJSONTyped(json, false);
}

export function WriteStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): WriteStatus {
    return json as WriteStatus;
}

export function WriteStatusToJSON(value?: WriteStatus | null): any {
    return value as any;
}

export function WriteStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): WriteStatus {
    return value as WriteStatus;
}
