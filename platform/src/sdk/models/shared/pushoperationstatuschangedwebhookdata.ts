...
export namespace PushOperationStatusChangedWebhookData$ {
    ...
    export const inboundSchema = PushOperationStatusChangedWebhookData$inboundSchema;
    /** @deprecated use `PushOperationStatusChangedWebhookData$outboundSchema` instead. */
    export const outboundSchema = PushOperationStatusChangedWebhookData$outboundSchema;
