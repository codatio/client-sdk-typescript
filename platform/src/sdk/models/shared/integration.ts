...
export function IntegrationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Integration {
    ...
    return {
        ...
        ...(json['sourceId'] !== undefined ? { 'sourceId': json['sourceId'] == null ? undefined : json['sourceId'] } : {}),
        ...(json['sourceType'] !== undefined ? { 'sourceType': json['sourceType'] == null ? undefined : SourceTypeFromJSON(json['sourceType']) } : {}),
        ...(json['integrationId'] !== undefined ? { 'integrationId': json['integrationId'] == null ? undefined : json['integrationId'] } : {}),
        ...(json['isOfflineConnector'] !== undefined ? { 'isOfflineConnector': json['isOfflineConnector'] == null ? undefined : json['isOfflineConnector'] } : {}),
        ...(json['isBeta'] !== undefined ? { 'isBeta': json['isBeta'] == null ? undefined : json['isBeta'] } : {}),
        ...(json['dataProvidedBy'] !== undefined ? { 'dataProvidedBy': json['dataProvidedBy'] == null ? undefined : json['dataProvidedBy'] } : {}),
        ...(json['datatypeFeatures'] !== undefined ? { 'datatypeFeatures': json['datatypeFeatures'] == null ? undefined : ((json['datatypeFeatures'] as Array<any>).map(DataTypeFeatureFromJSON)) } : {}),
    };
}
