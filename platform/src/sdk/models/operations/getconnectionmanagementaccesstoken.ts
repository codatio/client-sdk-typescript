...
/** @internal */
export const GetConnectionManagementAccessTokenRequest$outboundSchema: z.ZodType<
...
export namespace GetConnectionManagementAccessTokenRequest$ {
    ...
    export const inboundSchema = GetConnectionManagementAccessTokenRequest$inboundSchema;
    /** @deprecated use `GetConnectionManagementAccessTokenRequest$outboundSchema` instead. */
    export const outboundSchema = GetConnectionManagementAccessTokenRequest$outboundSchema;
