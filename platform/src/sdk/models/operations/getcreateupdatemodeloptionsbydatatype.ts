...
/** @internal */
export const GetCreateUpdateModelOptionsByDataTypeRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const GetCreateUpdateModelOptionsByDataTypeRequest$outboundSchema: z.ZodType<
...
export namespace GetCreateUpdateModelOptionsByDataTypeRequest$ {
    ...
    export const inboundSchema = GetCreateUpdateModelOptionsByDataTypeRequest$inboundSchema;
    /** @deprecated use `GetCreateUpdateModelOptionsByDataTypeRequest$outboundSchema` instead. */
    export const outboundSchema = GetCreateUpdateModelOptionsByDataTypeRequest$outboundSchema;
