...
export class PushData extends ClientSDK {
    ...
    async getModelOptions(
        ...
        const [result$] = await this.matcher<models.PushOption>()
            .json(200, models.PushOption$)
    ...
    async listOperations(
        ...
        const [result$] = await this.matcher<models.PushOperations>()
            .json(200, models.PushOperations$)
    ...
    async getOperation(
        ...
        const [result$] = await this.matcher<models.PushOperation>()
            .json(200, models.PushOperation$)
            .json([401, 402, 403, 404, 429, 500, 503], models.ErrorMessage$, { err: true })
            .fail(["4XX", "5XX"])
            .match(response, { extraFields: responseFields$ });
