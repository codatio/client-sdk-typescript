...
export class Settings extends ClientSDK {
    ...
    async createApiKey(
        ...
        const [result$] = await this.matcher<models.CreateApiKeyResponse>()
            .json(201, models.CreateApiKeyResponse$, { key: "ApiKeyDetails" })
    ...
    async deleteApiKey(
        ...
        options?: RequestOptions & { retries?: retries$.RetryConfig }
    ): Promise<models.DeleteApiKeyResponse> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
        headers$.set("Accept", "application/json");
        ...
        const [result$] = await this.matcher<models.DeleteApiKeyResponse>()
            .json([204, 401, 402, 403, 404, 429, 500, 503], models.DeleteApiKeyResponse$, {
                key: "ErrorMessage",
            })
            .match(response, { extraFields: responseFields$ });
    ...
    async getProfile(
        ...
        const [result$] = await this.matcher<models.GetProfileResponse>()
            .json(200, models.GetProfileResponse$, { key: "Profile" })
    ...
    async getSyncSettings(
        ...
        const [result$] = await this.matcher<models.GetProfileSyncSettingsResponse>()
            .json(200, models.GetProfileSyncSettingsResponse$, { key: "SyncSettings" })
    ...
    async listApiKeys(
        ...
        const [result$] = await this.matcher<models.ListApiKeysResponse>()
            .json(200, models.ListApiKeysResponse$, { key: "ApiKeys" })
    ...
    async updateProfile(
        ...
        const [result$] = await this.matcher<models.UpdateProfileResponse>()
            .json(200, models.UpdateProfileResponse$, { key: "Profile" })
    ...
    async updateSyncSettings(
        ...
        options?: RequestOptions & { retries?: retries$.RetryConfig }
    ): Promise<models.UpdateProfileSyncSettingsResponse> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
        headers$.set("Content-Type", "application/json");
        ...
        const [result$] = await this.matcher<models.UpdateProfileSyncSettingsResponse>()
            .void(204, models.UpdateProfileSyncSettingsResponse$)
            .json([401, 402, 403, 429, 500, 503], models.UpdateProfileSyncSettingsResponse$, {
                key: "ErrorMessage",
            })
            .match(response, { extraFields: responseFields$ });
