...
export class Webhooks extends ClientSDK {
    ...
    async list(
        ...
        const [result$] = await this.matcher<shared.Webhooks>()
            .json(200, shared.Webhooks$inboundSchema)
    ...
    async create(
        ...
        const [result$] = await this.matcher<shared.Webhook>()
            .json(200, shared.Webhook$inboundSchema)
     ...
     */
    async listConsumers(options?: RequestOptions): Promise<shared.WebhookConsumers> {
        ...
        const [result$] = await this.matcher<shared.WebhookConsumers>()
            .json(200, shared.WebhookConsumers$inboundSchema)
    ...
    async createConsumer(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => shared.WebhookConsumerPrototype$outboundSchema.optional().parse(value$),
            "Input validation failed"
        );
        const body$ =
            payload$ === undefined ? null : encodeJSON$("body", payload$, { explode: true });
        ...
        const [result$] = await this.matcher<shared.WebhookConsumer>()
            .json(201, shared.WebhookConsumer$inboundSchema)
            .json([400, 401, 402, 403, 429, 500, 503], errors.ErrorMessage$inboundSchema, {
                err: true,
            })
            .fail(["4XX", "5XX"])
    ...
    async deleteConsumer(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.DeleteWebhookConsumerRequest$outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
