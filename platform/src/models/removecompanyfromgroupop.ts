...
export type RemoveCompanyFromGroupResponse = {
    /**
...
/** @internal */
export namespace RemoveCompanyFromGroupResponse$ {
    export const inboundSchema: z.ZodType<RemoveCompanyFromGroupResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RemoveCompanyFromGroupResponse> =
        z
            .object({
                contentType: z.string(),
