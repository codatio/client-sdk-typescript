...
export namespace PushOperation$ {
    export const inboundSchema: z.ZodType<PushOperation, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PushOperation> = z.object({
