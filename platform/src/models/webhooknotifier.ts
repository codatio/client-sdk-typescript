...
export namespace WebhookNotifier$ {
    export const inboundSchema: z.ZodType<WebhookNotifier, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, WebhookNotifier> = z
        .object({
            emails: z.array(z.string()).optional(),
            webhook: z.string().optional(),
        })
