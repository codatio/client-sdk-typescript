...
export namespace GetProfileResponse$ {
    export const inboundSchema: z.ZodType<GetProfileResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetProfileResponse> = z
        .object({
            contentType: z.string(),
