...
import { WebhookConsumer, WebhookConsumer$ } from "./webhookconsumer.js";
...
export namespace WebhookConsumers$ {
    export const inboundSchema: z.ZodType<WebhookConsumers, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, WebhookConsumers> = z.object({
