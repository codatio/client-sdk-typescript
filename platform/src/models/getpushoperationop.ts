...
export type GetPushOperationResponse = {
     ...
     * OK
     */
    pushOperation?: PushOperation | undefined;
    /**
...
export namespace GetPushOperationResponse$ {
    export const inboundSchema: z.ZodType<GetPushOperationResponse, z.ZodTypeDef, unknown> = z
        .object({
            ContentType: z.string(),
            ErrorMessage: ErrorMessage$.inboundSchema.optional(),
            PushOperation: PushOperation$.inboundSchema.optional(),
    ...
    export type Outbound = {
        ...
        PushOperation?: PushOperation$.Outbound | undefined;
        StatusCode: number;
        RawResponse: never;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetPushOperationResponse> = z
        .object({
            ...
            pushOperation: PushOperation$.outboundSchema.optional(),
            statusCode: z.number().int(),
