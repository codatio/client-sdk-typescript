...
export namespace SyncSetting$ {
    export const inboundSchema: z.ZodType<SyncSetting, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, SyncSetting> = z.object({
