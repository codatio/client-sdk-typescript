...
async function run() {
  const result = await codatSyncPayroll.journalEntries.list({
...
**Promise\<[shared.JournalEntries](../../sdk/models/shared/journalentries.md)\>**
### Errors
...
async function run() {
  const result = await codatSyncPayroll.journalEntries.get({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
**Promise\<[shared.JournalEntry](../../sdk/models/shared/journalentry.md)\>**
### Errors
...
async function run() {
  const result = await codatSyncPayroll.journalEntries.delete({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
async function run() {
  const result = await codatSyncPayroll.journalEntries.getCreateModel({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
  });
...
async function run() {
  const result = await codatSyncPayroll.journalEntries.create({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    journalEntry: {
