...
async function run() {
  ...
  const result = await sdk.manageData.getDataStatus({
...
async function run() {
  ...
  const result = await sdk.manageData.getPullOperation({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
async function run() {
  ...
  const result = await sdk.manageData.getPushOperation({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
async function run() {
  ...
  const result = await sdk.manageData.list({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
async function run() {
  ...
  const result = await sdk.manageData.listPullOperations({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    orderBy: "-modifiedDate",
    page: 1,
    pageSize: 100,
...
async function run() {
  ...
  const result = await sdk.manageData.refreshAllDataTypes({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  });
...
```typescript
import { CodatSyncPayroll } from "@codat/sync-for-payroll";
import { SchemaDataType } from "@codat/sync-for-payroll/sdk/models/shared";
...
async function run() {
  ...
  const result = await sdk.manageData.refreshDataType({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
