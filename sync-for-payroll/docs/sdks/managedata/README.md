...
async function run() {
  await codatSyncPayroll.manageData.refreshAllDataTypes({
...
async function run() {
  const result = await codatSyncPayroll.manageData.getDataStatus({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  });
...
async function run() {
  const result = await codatSyncPayroll.manageData.refreshDataType({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    dataType: "invoices",
  });
...
async function run() {
  const result = await codatSyncPayroll.manageData.listPullOperations({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    page: 1,
    pageSize: 100,
...
async function run() {
  const result = await codatSyncPayroll.manageData.list({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    page: 1,
    pageSize: 100,
    query: "id=e3334455-1aed-4e71-ab43-6bccf12092ee",
...
async function run() {
  const result = await codatSyncPayroll.manageData.getPullOperation({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
...
async function run() {
  const result = await codatSyncPayroll.manageData.getPushOperation({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
