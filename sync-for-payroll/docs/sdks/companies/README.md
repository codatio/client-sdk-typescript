...
async function run() {
  const result = await codatSyncPayroll.companies.create({
    name: "Technicalium",
...
async function run() {
  const result = await codatSyncPayroll.companies.update({
...
async function run() {
  await codatSyncPayroll.companies.delete({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  });
...
async function run() {
  const result = await codatSyncPayroll.companies.get({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
  });
