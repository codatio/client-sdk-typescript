...
export class Accounts extends ClientSDK {
    ...
    async list(
        ...
        const [result$] = await this.matcher<shared.Accounts>()
            .json(200, shared.Accounts$inboundSchema)
            .json(
    ...
    async get(
        ...
        const [result$] = await this.matcher<shared.Account>()
            .json(200, shared.Account$inboundSchema)
    ...
    async getCreateModel(
        request: operations.GetCreateAccountsModelRequest,
        options?: RequestOptions
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCreateAccountsModelRequest$outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
