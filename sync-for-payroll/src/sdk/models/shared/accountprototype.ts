...
export namespace AccountPrototypeValidDataTypeLinks$ {
    ...
    export const outboundSchema = AccountPrototypeValidDataTypeLinks$outboundSchema;
...
/** @internal */
export const AccountPrototype$inboundSchema: z.ZodType<AccountPrototype, z.ZodTypeDef, unknown> =
    z.object({
