 ...
 */
export type AccountValidDataTypeLinks = {
    /**
...
export type Account = {
     ...
     */
    validDatatypeLinks?: Array<AccountValidDataTypeLinks> | null | undefined;
};
...
export namespace AccountMetadata$ {
    ...
    export const inboundSchema: z.ZodType<AccountMetadata, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountMetadata> = z
        .object({
            isDeleted: z.nullable(z.boolean()).optional(),
        })
        .transform((v) => {
...
/** @internal */
export namespace AccountValidDataTypeLinks$ {
    export type Inbound = {
        links?: Array<string> | null | undefined;
        property?: string | null | undefined;
    };

    export const inboundSchema: z.ZodType<AccountValidDataTypeLinks, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountValidDataTypeLinks> = z
        .object({
            links: z.nullable(z.array(z.string())).optional(),
            property: z.nullable(z.string()).optional(),
        })
...
export namespace Account$ {
    export type Inbound = {
        ...
        id?: string | undefined;
        isBankAccount?: boolean | undefined;
        metadata?: AccountMetadata$.Inbound | undefined;
        modifiedDate?: string | undefined;
        name?: string | null | undefined;
        nominalCode?: string | null | undefined;
        sourceModifiedDate?: string | undefined;
        ...
        type?: AccountType | undefined;
        validDatatypeLinks?: Array<AccountValidDataTypeLinks$.Inbound> | null | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<Account, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            metadata: z.lazy(() => AccountMetadata$.inboundSchema).optional(),
            ...
            validDatatypeLinks: z
                .nullable(z.array(z.lazy(() => AccountValidDataTypeLinks$.inboundSchema)))
                .optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        id?: string | undefined;
        isBankAccount?: boolean | undefined;
        metadata?: AccountMetadata$.Outbound | undefined;
        modifiedDate?: string | undefined;
        name?: string | null | undefined;
        nominalCode?: string | null | undefined;
        sourceModifiedDate?: string | undefined;
        ...
        type?: AccountType | undefined;
        validDatatypeLinks?: Array<AccountValidDataTypeLinks$.Outbound> | null | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Account> = z
        .object({
            ...
            id: z.string().optional(),
            isBankAccount: z.boolean().optional(),
            metadata: z.lazy(() => AccountMetadata$.outboundSchema).optional(),
            modifiedDate: z.string().optional(),
            name: z.nullable(z.string()).optional(),
            nominalCode: z.nullable(z.string()).optional(),
            sourceModifiedDate: z.string().optional(),
            ...
            type: AccountType$.optional(),
            validDatatypeLinks: z
                .nullable(z.array(z.lazy(() => AccountValidDataTypeLinks$.outboundSchema)))
                .optional(),
        })
        .transform((v) => {
            return {
