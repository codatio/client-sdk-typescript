...
/** @internal */
export const AccountMetadata$inboundSchema: z.ZodType<AccountMetadata, z.ZodTypeDef, unknown> =
    z.object({
        isDeleted: z.nullable(z.boolean()).optional(),
    });

/** @internal */
export type AccountMetadata$Outbound = {
    isDeleted?: boolean | null | undefined;
};

/** @internal */
export const AccountMetadata$outboundSchema: z.ZodType<
    AccountMetadata$Outbound,
    z.ZodTypeDef,
    AccountMetadata
> = z.object({
    isDeleted: z.nullable(z.boolean()).optional(),
...
export namespace AccountMetadata$ {
    /** @deprecated use `AccountMetadata$inboundSchema` instead. */
    export const inboundSchema = AccountMetadata$inboundSchema;
    /** @deprecated use `AccountMetadata$outboundSchema` instead. */
    export const outboundSchema = AccountMetadata$outboundSchema;
    /** @deprecated use `AccountMetadata$Outbound` instead. */
    export type Outbound = AccountMetadata$Outbound;
}
