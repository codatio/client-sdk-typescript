 ...
 * Name of underlying data type.
 */
export type TrackingRecordRefDataType = ClosedEnum<typeof TrackingRecordRefDataType>;
...
/** @internal */
export const TrackingRecordRef$inboundSchema: z.ZodType<TrackingRecordRef, z.ZodTypeDef, unknown> =
    z.object({
