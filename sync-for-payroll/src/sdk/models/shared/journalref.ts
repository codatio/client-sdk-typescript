...
/** @internal */
export const JournalRef$inboundSchema: z.ZodType<JournalRef, z.ZodTypeDef, unknown> = z.object({
    id: z.string(),
...
/** @internal */
export const JournalRef$outboundSchema: z.ZodType<JournalRef$Outbound, z.ZodTypeDef, JournalRef> =
    z.object({
        id: z.string(),
        name: z.nullable(z.string()).optional(),
    });
