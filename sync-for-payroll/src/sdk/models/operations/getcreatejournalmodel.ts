...
export type GetCreateJournalModelResponse = {
    /**
...
export namespace GetCreateJournalModelRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetCreateJournalModelRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreateJournalModelRequest> = z
        .object({
            companyId: z.string(),
            connectionId: z.string(),
        })
...
/** @internal */
export namespace GetCreateJournalModelResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<GetCreateJournalModelResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreateJournalModelResponse> =
        z
            .object({
                contentType: z.string(),
