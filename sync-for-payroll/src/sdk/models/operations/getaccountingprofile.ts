...
export class GetAccountingProfileCompanyInformationAccountingAddress extends SpeakeasyBase {
    /**
...
export class GetAccountingProfileCompanyInformationPhone extends SpeakeasyBase {
    /**
     * A phone number.
     */
    @SpeakeasyMetadata()
 ...
 */
export enum GetAccountingProfileCompanyInformationWeblinkType {
    Website = "Website",
    Social = "Social",
    Unknown = "Unknown",
}
 ...
 */
export class GetAccountingProfileCompanyInformationWeblink extends SpeakeasyBase {
    /**
     * The type of the weblink.
     */
    @SpeakeasyMetadata()
    @Expose({ name: "type" })
    type?: GetAccountingProfileCompanyInformationWeblinkType;
 ...
 */
export class GetAccountingProfileCompanyInformation extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({ elemType: GetAccountingProfileCompanyInformationAccountingAddress })
    @Expose({ name: "addresses" })
    @Type(() => GetAccountingProfileCompanyInformationAccountingAddress)
    addresses?: GetAccountingProfileCompanyInformationAccountingAddress[];
     ...
     */
    @SpeakeasyMetadata({ elemType: GetAccountingProfileCompanyInformationPhone })
    @Expose({ name: "phoneNumbers" })
    @Type(() => GetAccountingProfileCompanyInformationPhone)
    phoneNumbers?: GetAccountingProfileCompanyInformationPhone[];
     ...
     */
    @SpeakeasyMetadata({ elemType: GetAccountingProfileCompanyInformationWeblink })
    @Expose({ name: "webLinks" })
    @Type(() => GetAccountingProfileCompanyInformationWeblink)
    webLinks?: GetAccountingProfileCompanyInformationWeblink[];
}
