        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.sendOrdersData200ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  sendPaymentsData(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.sendPaymentsData200ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  sendTransactionsData(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.sendTransactionsData200ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
